    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        if (maxErrs > 0) {
            ...
            if (errCount > 0) {
                ...
                System.out.print(errCount > 1 ? "s" : XMLConstants.NULL_NS_URI);
            ...
            if (warnCount > 0) {
                ...
                System.out.print(warnCount > 1 ? "s" : XMLConstants.NULL_NS_URI);
                System.out.print(".");
            } else {
                System.out.print("no warnings.");
            }
            System.out.println(XMLConstants.NULL_NS_URI);
        }
