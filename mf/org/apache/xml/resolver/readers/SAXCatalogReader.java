...
public class SAXCatalogReader implements CatalogReader, ContentHandler, DocumentHandler {
    ...
    public void setCatalogParser(String namespaceURI, String rootElement, String parserClass) {
        this.namespaceMap.put("{" + (namespaceURI != null ? namespaceURI.trim() : XMLConstants.NULL_NS_URI) + "}" + rootElement, parserClass);
    }

    public String getCatalogParser(String namespaceURI, String rootElement) {
        return (String) this.namespaceMap.get("{" + (namespaceURI != null ? namespaceURI.trim() : XMLConstants.NULL_NS_URI) + "}" + rootElement);
    }
    ...
    public void startElement(String name, AttributeList atts) throws SAXException {
        if (!this.abandonHope) {
            if (this.saxParser == null) {
                String namespaceURI;
                String prefix = XMLConstants.NULL_NS_URI;
                ...
                if (prefix.equals(XMLConstants.NULL_NS_URI)) {
