...
public class XSConstraints {
    ...
    class C10471 implements Comparator {
        C10471() {
        }
    ...
    static {
        ...
        fEmptyParticle = null;
        ELEMENT_PARTICLE_COMPARATOR = new C10471();
    }
                        ...
                        if (types[j].fBaseType instanceof XSComplexTypeDecl) {
                            ...
                            if (derivedParticle == null) {
                                ...
                                try {
                                    ...
                                    r31 = new Object[1];
                                    r31[0] = types[j].fName;
                                    reportSchemaError(errorReporter, simpleLocator, "derivation-ok-restriction.5.4.2", r31);
                                }
                            } else {
                                simpleLocator = ctLocators[j];
                                r31 = new Object[1];
