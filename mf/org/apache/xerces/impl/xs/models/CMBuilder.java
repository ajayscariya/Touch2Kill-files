...
public class CMBuilder {
    ...
    private CMNode expandContentModel(CMNode node, int minOccurs, int maxOccurs) {
        ...
        if (maxOccurs == -1) {
            return this.fNodeFactory.getCMBinOpNode(C0866R.styleable.Theme_checkboxStyle, multiNodes(node, minOccurs - 1, true), this.fNodeFactory.getCMUniOpNode(6, node));
        }
        if (minOccurs > 0) {
        ...
        return this.fNodeFactory.getCMBinOpNode(C0866R.styleable.Theme_checkboxStyle, nodeRet, multiNodes(node, maxOccurs - minOccurs, true));
    }
    ...
    private CMNode multiNodes(CMNode node, int num, boolean copyFirst) {
        ...
        if (num != 1) {
            int num1 = num / 2;
            return this.fNodeFactory.getCMBinOpNode(C0866R.styleable.Theme_checkboxStyle, multiNodes(node, num1, copyFirst), multiNodes(node, num - num1, true));
        } else if (copyFirst) {
