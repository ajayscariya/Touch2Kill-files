...
public class XSNamedMapImpl extends AbstractMap implements XSNamedMap {
    ...
    class C10491 extends AbstractSet {
        ...
        class C10481 implements Iterator {
            private int index;
            private final /* synthetic */ XSNamedMapEntry[] val$entries;
            private final /* synthetic */ int val$length;

            C10481(int i, XSNamedMapEntry[] xSNamedMapEntryArr) {
                this.val$length = i;
        ...
        C10491(int i, XSNamedMapEntry[] xSNamedMapEntryArr) {
            this.val$length = i;
            this.val$entries = xSNamedMapEntryArr;
        }

        public Iterator iterator() {
            return new C10481(this.val$length, this.val$entries);
        }
    ...
    public synchronized Set entrySet() {
        if (this.fEntrySet == null) {
            ...
            this.fEntrySet = new C10491(length, entries);
        }
