...
public class XSImplementationImpl extends PSVIDOMImplementationImpl implements XSImplementation {
    ...
    public boolean hasFeature(String feature, String version) {
        return (feature.equalsIgnoreCase("XS-Loader") && (version == null || version.equals(BuildConfig.VERSION_NAME))) || super.hasFeature(feature, version);
    }
    ...
    public XSLoader createXSLoader(StringList versions) throws XSException {
        ...
        if (versions != null) {
            ...
            while (i < versions.getLength()) {
                if (versions.item(i).equals(BuildConfig.VERSION_NAME)) {
                    i++;
                } else {
    ...
    public StringList getRecognizedVersions() {
        return new StringListImpl(new String[]{BuildConfig.VERSION_NAME}, 1);
    }
}
