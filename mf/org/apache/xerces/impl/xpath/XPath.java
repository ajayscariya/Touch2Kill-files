...
public class XPath {
    ...
    private static class Scanner {
        ...
        static {
            ...
            bArr[DownloadsListActivity.DOWNLOAD_COMPLETE] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_checkboxStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_checkedTextViewStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_editTextStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_radioButtonStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_ratingBarStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_seekBarStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_spinnerStyle] = CHARTYPE_LETTER;
            bArr[C0866R.styleable.Theme_switchStyle] = CHARTYPE_LETTER;
    ...
    class C14901 extends Scanner {
        C14901(SymbolTable $anonymous0) {
            super($anonymous0);
        }
    ...
    private LocationPath[] parseExpression(NamespaceContext context) throws XPathException {
        ...
        if (new C14901(this.fSymbolTable).scanExpr(this.fSymbolTable, xtokens, this.fExpression, 0, this.fExpression.length())) {
