...
class RegexParser {
    ...
    Token processBacksolidus_i() throws ParseException {
        Token tok = Token.createChar(C0866R.styleable.Theme_radioButtonStyle);
        next();
        return tok;
    }
        ...
        switch (read()) {
            case T_BACKSOLIDUS /*10*/:
                switch (this.chardata) {
                    ...
                    case C0866R.styleable.Theme_textAppearanceSearchResultTitle /*65*/:
                        return processBacksolidus_A();
                    case C0866R.styleable.Theme_textAppearanceSearchResultSubtitle /*66*/:
                        return processBacksolidus_B();
                    case C0866R.styleable.Theme_controlBackground /*90*/:
                        return processBacksolidus_Z();
                    case C0866R.styleable.Theme_buttonBarNeutralButtonStyle /*98*/:
                        return processBacksolidus_b();
                    case 122:
                        return processBacksolidus_z();
                    default:
    ...
    Token parseAtom() throws ParseException {
        ...
        switch (read()) {
            ...
            case T_BACKSOLIDUS /*10*/:
                switch (this.chardata) {
                    case C0866R.styleable.Theme_actionButtonStyle /*49*/:
                    case MetaData.DEFAULT_HTML_3D_PROBABILITY_3D /*50*/:
                    case C0866R.styleable.Theme_buttonBarButtonStyle /*51*/:
                    case C0866R.styleable.Theme_selectableItemBackground /*52*/:
                    case C0866R.styleable.Theme_selectableItemBackgroundBorderless /*53*/:
                    case C0866R.styleable.Theme_borderlessButtonStyle /*54*/:
                    case C0866R.styleable.Theme_dividerVertical /*55*/:
                    case C0866R.styleable.Theme_dividerHorizontal /*56*/:
                    case C0866R.styleable.Theme_activityChooserViewStyle /*57*/:
                        return processBackreference();
                    case C0866R.styleable.Theme_textColorSearchUrl /*67*/:
                        return processBacksolidus_C();
                    case C0866R.styleable.Theme_searchViewStyle /*68*/:
                    case C0866R.styleable.Theme_colorPrimaryDark /*83*/:
                    case C0866R.styleable.Theme_colorControlHighlight /*87*/:
                    case MainNavigationActivity.REQUEST_SELECT_FILE /*100*/:
                    case 115:
                    case 119:
                        tok = getTokenForShorthand(this.chardata);
                        next();
                        return tok;
                    case C0866R.styleable.Theme_listPreferredItemPaddingRight /*73*/:
                    ...
                    case 112:
                        ...
                        break;
                    case C0866R.styleable.Theme_colorButtonNormal /*88*/:
                        return processBacksolidus_X();
                    case C0866R.styleable.Theme_autoCompleteTextViewStyle /*99*/:
                        return processBacksolidus_c();
                    case DownloadsListActivity.DOWNLOAD_COMPLETE /*101*/:
                    case C0866R.styleable.Theme_checkboxStyle /*102*/:
                    case 110:
                    case 114:
                    case 116:
                    case 117:
                    ...
                    case 120:
                        ...
                        break;
                    case C0866R.styleable.Theme_checkedTextViewStyle /*103*/:
                        return processBacksolidus_g();
                    case C0866R.styleable.Theme_radioButtonStyle /*105*/:
                        return processBacksolidus_i();
                    default:
                        tok = Token.createChar(this.chardata);
                        break;
    ...
    private static final int hexChar(int ch) {
        if (ch < 48 || ch > C0866R.styleable.Theme_checkboxStyle) {
            return -1;
        }
        if (ch <= 57) {
            return ch - 48;
