...
class ParserForXMLSchema extends RegexParser {
    ...
    Token processBacksolidus_i() throws ParseException {
        next();
        return getTokenForShorthand(C0866R.styleable.Theme_radioButtonStyle);
    }
    ...
    int decodeEscaped() throws ParseException {
        ...
        switch (c) {
            ...
            case C0866R.styleable.Theme_editTextBackground /*63*/:
            case C0866R.styleable.Theme_alertDialogStyle /*91*/:
            case C0866R.styleable.Theme_alertDialogButtonGroupStyle /*92*/:
            case C0866R.styleable.Theme_alertDialogCenterButtons /*93*/:
            case C0866R.styleable.Theme_alertDialogTheme /*94*/:
            case 123:
            case 124:
            case 125:
                return c;
