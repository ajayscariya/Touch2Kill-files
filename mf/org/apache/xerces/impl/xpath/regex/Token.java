...
class Token implements Serializable {
    ...
    static class ModifierToken extends Token implements Serializable {
        ...
        public String toString(int options) {
            return "(?" + (this.add == 0 ? XMLConstants.NULL_NS_URI : REUtil.createOptionString(this.add)) + (this.mask == 0 ? XMLConstants.NULL_NS_URI : REUtil.createOptionString(this.mask)) + ":" + this.child.toString(options) + ")";
        }
    }
    ...
    public String toString(int options) {
        return this.type == DOT ? "." : XMLConstants.NULL_NS_URI;
    }
