...
final class StAXEventResultBuilder implements StAXDocumentHandler {
    ...
    class C10511 implements Iterator {
        C10511() {
        }
    ...
    final class AttributeIterator implements Iterator {
        ...
        public Object next() {
            if (hasNext()) {
                ...
                String str2 = StAXEventResultBuilder.this.fAttrName.uri != null ? StAXEventResultBuilder.this.fAttrName.uri : XMLConstants.NULL_NS_URI;
    ...
    public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
        try {
            ...
            this.fEventWriter.add(this.fEventFactory.createStartElement(element.prefix, element.uri != null ? element.uri : XMLConstants.NULL_NS_URI, element.localpart, getAttributeIterator(attributes, length), getNamespaceIterator(), this.fNamespaceContext.getNamespaceContext()));
        } catch (Exception e) {
    ...
    static {
        EMPTY_COLLECTION_ITERATOR = new C10511();
    }
}
