...
final class JAXPValidatorComponent extends TeeXMLDocumentFilterImpl implements XMLComponent {
    ...
    class C14911 extends TypeInfoProvider {
        C14911() {
        }
    ...
    class C14922 extends ErrorHandlerProxy {
        C14922() {
        }
    ...
    class C14933 implements LSResourceResolver {
        C14933() {
        }
    ...
    private static final class XNI2SAX extends DefaultXMLDocumentHandler {
        ...
        public void startElement(QName element, XMLAttributes attributes, Augmentations augs) throws XNIException {
            try {
                ...
                uri = element.uri != null ? element.uri : XMLConstants.NULL_NS_URI;
        ...
        public void endElement(QName element, Augmentations augs) throws XNIException {
            try {
                this.fContentHandler.endElement(element.uri != null ? element.uri : XMLConstants.NULL_NS_URI, element.localpart, element.rawname);
                int count = this.fNamespaceContext.getDeclaredPrefixCount();
                if (count > 0) {
                    for (int i = 0; i < count; i++) {
    ...
    public JAXPValidatorComponent(ValidatorHandler validatorHandler) {
        ...
        this.validator.setErrorHandler(new C14922());
        this.validator.setResourceResolver(new C14933());
    }
