...
class XMLGregorianCalendarImpl extends XMLGregorianCalendar implements Serializable, Cloneable {
                ...
                if (fch != '%') {
                    ...
                    switch (str.charAt(i)) {
                        case C0866R.styleable.Theme_searchViewStyle /*68*/:
                            ...
                            break;
                        case C0866R.styleable.Theme_textAppearanceListItemSmall /*77*/:
                        ...
                        case C0866R.styleable.Theme_colorSwitchThumbNormal /*89*/:
                            parseYear();
                            break;
                        case C0866R.styleable.Theme_editTextStyle /*104*/:
    ...
    static {
        ...
        LEAP_YEAR_DEFAULT = createDateTime(400, (int) MONTH, MONTH, (int) YEAR, YEAR, YEAR, (int) ExploreByTouchHelper.INVALID_ID, ExploreByTouchHelper.INVALID_ID);
    ...
    private static int maximumDayInMonthFor(int year, int month) {
        ...
        if (year % 400 == 0 || (year % 100 != 0 && year % MINUTE == 0)) {
            return 29;
        }
