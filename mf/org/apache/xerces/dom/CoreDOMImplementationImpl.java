...
public class CoreDOMImplementationImpl implements DOMImplementation, DOMImplementationLS {
    ...
    public boolean hasFeature(String feature, String version) {
        ...
        if (feature.equalsIgnoreCase("Core") && (anyVersion || version.equals(BuildConfig.VERSION_NAME) || version.equals("2.0") || version.equals("3.0"))) {
            return true;
        }
        if (feature.equalsIgnoreCase("XML") && (anyVersion || version.equals(BuildConfig.VERSION_NAME) || version.equals("2.0") || version.equals("3.0"))) {
            return true;
        }
        if (feature.equalsIgnoreCase("XMLVersion") && (anyVersion || version.equals(BuildConfig.VERSION_NAME) || version.equals("1.1"))) {
            return true;
        }
        if (feature.equalsIgnoreCase("LS") && (anyVersion || version.equals("3.0"))) {
            return true;
        }
        if (feature.equalsIgnoreCase("ElementTraversal") && (anyVersion || version.equals(BuildConfig.VERSION_NAME))) {
            return true;
        }
        return false;
    }
