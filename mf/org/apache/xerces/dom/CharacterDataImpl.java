...
public abstract class CharacterDataImpl extends ChildNode {
    ...
    class C14851 implements NodeList {
        C14851() {
        }
    ...
    void internalDeleteData(int offset, int count, boolean replace) throws DOMException {
        ...
        try {
            setNodeValueInternal(new StringBuilder(String.valueOf(this.data.substring(0, offset))).append(tailLength > 0 ? this.data.substring(offset + count, (offset + count) + tailLength) : XMLConstants.NULL_NS_URI).toString(), replace);
