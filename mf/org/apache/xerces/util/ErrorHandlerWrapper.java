...
public class ErrorHandlerWrapper implements XMLErrorHandler {
    ...
    class C14941 implements XMLLocator {
        ...
        C14941(String str, String str2, int i, int i2) {
    ...
    protected static XMLParseException createXMLParseException(SAXParseException exception) {
        return new XMLParseException(new C14941(exception.getPublicId(), exception.getSystemId(), exception.getColumnNumber(), exception.getLineNumber()), exception.getMessage(), exception);
    }
