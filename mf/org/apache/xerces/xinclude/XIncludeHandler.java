...
public class XIncludeHandler implements XMLComponent, XMLDocumentFilter, XMLDTDFilter {
    ...
    static {
        ...
        NEW_NS_ATTR_QNAME = new QName(XMLSymbols.PREFIX_XMLNS, XMLConstants.NULL_NS_URI, XMLSymbols.PREFIX_XMLNS + ":", NamespaceContext.XMLNS_URI);
    ...
    private String escapeHref(String href) {
        ...
        if (i < len) {
            ...
            try {
                byte[] bytes = href.substring(i).getBytes(Defaults.Encoding);
                len = bytes.length;
