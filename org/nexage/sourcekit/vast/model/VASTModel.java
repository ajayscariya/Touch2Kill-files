...
public class VASTModel implements Serializable {
    ...
    public HashMap<TRACKING_EVENTS_TYPE, List<String>> getTrackingUrls() {
        VASTLog.m3962d(TAG, "getTrackingUrls");
        ...
        for (int i = 0; i < nodes.getLength(); i++) {
            ...
            try {
                ...
                VASTLog.m3967w(TAG, "Event:" + eventName + " is not valid. Skipping it.");
            }
        }
        return trackings;
    }
    ...
    public List<VASTMediaFile> getMediaFiles() {
        VASTLog.m3962d(TAG, "getMediaFiles");
    ...
    public String getDuration() {
        VASTLog.m3962d(TAG, "getDuration");
    ...
    public VideoClicks getVideoClicks() {
        VASTLog.m3962d(TAG, "getVideoClicks");
