...
class TransportMediatorJellybeanMR2 {
    ...
    class C00641 implements OnWindowAttachListener {
        C00641() {
        }
    ...
    class C00652 implements OnWindowFocusChangeListener {
        C00652() {
        }
    ...
    class C00663 extends BroadcastReceiver {
        C00663() {
        }
    ...
    class C00674 implements OnAudioFocusChangeListener {
        C00674() {
        }
    ...
    class C00685 implements OnGetPlaybackPositionListener {
        C00685() {
        }
    ...
    class C00696 implements OnPlaybackPositionUpdateListener {
        C00696() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00641();
        this.mWindowFocusListener = new C00652();
        this.mMediaButtonReceiver = new C00663();
        this.mAudioFocusChangeListener = new C00674();
        this.mGetPlaybackPositionListener = new C00685();
        this.mPlaybackPositionUpdateListener = new C00696();
        this.mPlayState = 0;
