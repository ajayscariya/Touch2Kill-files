...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C11313 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ String val$parentId;

        C11313(Object x0, String str, ConnectionRecord connectionRecord) {
            this.val$parentId = str;
    ...
    class C11324 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C11324(Object x0, ResultReceiver resultReceiver) {
    ...
    private class ServiceBinder extends Stub {
        ...
        class C00551 implements Runnable {
            ...
            C00551(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00562 implements Runnable {
            ...
            C00562(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00573 implements Runnable {
            ...
            C00573(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00584 implements Runnable {
            final /* synthetic */ IMediaBrowserServiceCompatCallbacks val$callbacks;
            final /* synthetic */ String val$id;

            C00584(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00595 implements Runnable {
            final /* synthetic */ String val$mediaId;
            final /* synthetic */ ResultReceiver val$receiver;

            C00595(String str, ResultReceiver resultReceiver) {
        ...
        public void connect(String pkg, Bundle rootHints, IMediaBrowserServiceCompatCallbacks callbacks) {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00551(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00562(callbacks));
        }

        public void addSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00573(callbacks, id));
        }

        public void removeSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00584(callbacks, id));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00595(mediaId, receiver));
            }
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00531(token));
        }
    }
    ...
    public void notifyChildrenChanged(@NonNull String parentId) {
        ...
        this.mHandler.post(new C00542(parentId));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection) {
        Result<List<MediaItem>> result = new C11313(parentId, parentId, connection);
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C11324(itemId, receiver);
