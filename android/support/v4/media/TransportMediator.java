...
public class TransportMediator extends TransportController {
    ...
    class C00632 implements Callback {
        C00632() {
        }
    ...
    class C11331 implements TransportMediatorCallback {
        C11331() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C11331();
        this.mKeyEventCallback = new C00632();
