...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00413 extends FutureTask<Result> {
        C00413(Callable x0) {
            super(x0);
        }
    ...
    class C11282 extends WorkerRunnable<Params, Result> {
        C11282() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C11282();
        this.mFuture = new C00413(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00424.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
