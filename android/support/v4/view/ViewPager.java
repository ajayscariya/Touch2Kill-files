...
public class ViewPager extends ViewGroup {
    ...
    static class C00991 implements Comparator<ItemInfo> {
        C00991() {
        }
    ...
    static class C01002 implements Interpolator {
        C01002() {
        }
    ...
    class C01013 implements Runnable {
        C01013() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C11431 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C11431() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C11431());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00991();
        sInterpolator = new C01002();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01013();
