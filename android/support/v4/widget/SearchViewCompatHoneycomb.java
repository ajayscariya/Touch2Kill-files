...
class SearchViewCompatHoneycomb {
    ...
    static class C01221 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01221(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01232 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01232(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
