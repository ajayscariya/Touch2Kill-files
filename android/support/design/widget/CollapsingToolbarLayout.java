...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C11031 implements OnApplyWindowInsetsListener {
        C11031() {
        }
    ...
    class C11042 implements AnimatorUpdateListener {
        C11042() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C11031());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C11042());
