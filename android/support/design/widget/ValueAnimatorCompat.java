...
class ValueAnimatorCompat {
    ...
    class C11201 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C11201(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C11212 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C11212(AnimatorListener animatorListener) {
    ...
    public void setUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.setUpdateListener(new C11201(updateListener));
        } else {
    ...
    public void setListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.setListener(new C11212(listener));
        } else {
