...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C11181 implements AnimatorUpdateListener {
            ...
            C11181(int i, int i2, int i3, int i4) {
        ...
        class C15002 extends AnimatorListenerAdapter {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C11181(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C15002(position));
                animator.start();
            }
        }
    ...
    class C11171 implements AnimatorUpdateListener {
        C11171() {
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabMaxWidth = ASContentModel.AS_UNBOUNDED;
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C11171());
                }
