...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C15091 extends ViewPropertyAnimatorListenerAdapter {
        C15091() {
        }
    ...
    static {
        ATTRS = new int[]{C0151R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C15091();
        this.mRemoveActionBarHideOffset = new C01542();
        this.mAddActionBarHideOffset = new C01553();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0151R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0151R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0151R.id.action_bar));
        }
    }
