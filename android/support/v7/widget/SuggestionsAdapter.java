...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0151R.id.edit_query);
        }
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        String query = constraint == null ? XMLConstants.NULL_NS_URI : constraint.toString();
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0151R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0151R.attr.textColorSearchUrl, colorValue, true);
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder uriBuilder = new Builder().scheme(AppLovinEventTypes.USER_VIEWED_CONTENT).authority(authority).query(XMLConstants.NULL_NS_URI).fragment(XMLConstants.NULL_NS_URI);
