...
class AlertController {
    ...
    class C01394 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01394(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C01411 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C01411(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class C01422 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01422(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C01433 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C01433(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C01444 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01444(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C01411(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c01422 = new C01422(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C01433(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C01444(listView, dialog));
            }
    ...
    class C11492 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C11492(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C01371();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(di);
        TypedArray a = context.obtainStyledAttributes(null, C0151R.styleable.AlertDialog, C0151R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0151R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0151R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0151R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0151R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0151R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0151R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0151R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0151R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0151R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0151R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0151R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0151R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0151R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0151R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0151R.id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0151R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0151R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C11492(top, bottom));
                this.mScrollView.post(new C01383(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01394(top, bottom));
                this.mListView.post(new C01405(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0151R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0151R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0151R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0151R.id.scrollView);
