...
public interface NanoAdshieldEvent {
    ...
    public static final class AdShieldEvent extends zzsu {
        ...
        public AdShieldEvent clear() {
            this.appId = XMLConstants.NULL_NS_URI;
            this.zzbuu = -1;
            return this;
        }
        ...
        public void writeTo(zzsn output) throws IOException {
            if (!this.appId.equals(XMLConstants.NULL_NS_URI)) {
        ...
        protected int zzz() {
            int zzz = super.zzz();
            return !this.appId.equals(XMLConstants.NULL_NS_URI) ? zzz + zzsn.zzo(1, this.appId) : zzz;
        }
    }
}
