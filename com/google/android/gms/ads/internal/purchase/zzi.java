...
public class zzi {
    ...
    class C04531 implements ServiceConnection {
        final /* synthetic */ zzi zzFZ;
        final /* synthetic */ Context zzxh;

        C04531(zzi com_google_android_gms_ads_internal_purchase_zzi, Context context) {
    ...
    public void zzz(Context context) {
        ServiceConnection c04531 = new C04531(this, context);
        Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        intent.setPackage(zze.GOOGLE_PLAY_STORE_PACKAGE);
        context.bindService(intent, c04531, 1);
    }
}
