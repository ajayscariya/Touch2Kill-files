...
public class zzd extends com.google.android.gms.internal.zzfv.zza implements zzs {
    ...
    class C12611 implements com.google.android.gms.internal.zzjq.zza {
        final /* synthetic */ zzd zzEv;

        C12611(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzim {
        ...
        class C04511 implements Runnable {
            ...
            C04511(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbr() {
            ...
            if (zzf != null) {
                zzir.zzMc.post(new C04511(this, zzr.zzbE().zza(this.zzEv.mActivity, zzf, this.zzEv.zzEh.zzEM.zzqo, this.zzEv.zzEh.zzEM.zzqp)));
            }
        }
    }
    ...
    protected void zzx(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzpD.zzhU().zza(new C12611(this));
            if (this.zzEh.url != null) {
                this.zzpD.loadUrl(this.zzEh.url);
            } else if (this.zzEh.zzEH != null) {
                this.zzpD.loadDataWithBaseURL(this.zzEh.zzEF, this.zzEh.zzEH, "text/html", Defaults.Encoding, null);
            } else {
