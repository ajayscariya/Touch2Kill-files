...
public class zzi implements zzh {
    ...
    class C12561 implements zzdf {
        final /* synthetic */ zzi zzyx;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzi.1.1 */
        class C12551 implements zzjq.zza {
            final /* synthetic */ Map zzyy;
            final /* synthetic */ C12561 zzyz;

            C12551(C12561 c12561, Map map) {
                this.zzyz = c12561;
                this.zzyy = map;
            }
        ...
        C12561(zzi com_google_android_gms_ads_internal_formats_zzi) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
            this.zzyx.zzpD.zzhU().zza(new C12551(this, map));
            String str = (String) map.get("overlayHtml");
            String str2 = (String) map.get("baseUrl");
            if (TextUtils.isEmpty(str2)) {
                this.zzyx.zzpD.loadData(str, "text/html", Defaults.Encoding);
            } else {
                this.zzyx.zzpD.loadDataWithBaseURL(str2, str, "text/html", Defaults.Encoding, null);
            }
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.formats.zzi.2 */
    class C12572 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C12572(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C12583 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C12583(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C12594 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C12594(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C12605 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C12605(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    public zzjp zzdR() {
        ...
        this.zzyr.zza("/loadHtml", new C12561(this));
        this.zzyr.zza("/showOverlay", new C12572(this));
        this.zzyr.zza("/hideOverlay", new C12583(this));
        this.zzpD.zzhU().zza("/hideOverlay", new C12594(this));
        this.zzpD.zzhU().zza("/sendMessageToSdk", new C12605(this));
        return this.zzpD;
    }
