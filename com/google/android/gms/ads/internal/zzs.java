...
public final class zzs implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzbY() {
            zzin.m4736v("Disable position monitoring on adFrame.");
            if (this.zzrV != null) {
                this.zzrV.zzhF();
            }
        }
    ...
    public String zzca() {
        return (this.zzrR && this.zzrS) ? XMLConstants.NULL_NS_URI : this.zzrR ? this.zzrT ? "top-scrollable" : "top-locked" : this.zzrS ? this.zzrT ? "bottom-scrollable" : "bottom-locked" : XMLConstants.NULL_NS_URI;
    }
