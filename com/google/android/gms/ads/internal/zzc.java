...
public abstract class zzc extends zzb implements zzg, zzft {
    ...
    class C04612 implements Runnable {
        ...
        C04612(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza) {
    ...
    class C04643 implements Runnable {
        final /* synthetic */ zzc zzpr;
        final /* synthetic */ zza zzps;
        final /* synthetic */ zzcb zzpt;

        /* renamed from: com.google.android.gms.ads.internal.zzc.3.1 */
        class C04621 implements OnTouchListener {
            final /* synthetic */ zze zzpu;
            final /* synthetic */ C04643 zzpv;

            C04621(C04643 c04643, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c04643;
        ...
        class C04632 implements OnClickListener {
            ...
            C04632(C04643 c04643, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c04643;
                this.zzpu = com_google_android_gms_ads_internal_zze;
            }
        ...
        C04643(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
            this.zzps = com_google_android_gms_internal_zzif_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C04621(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C04632(this, com_google_android_gms_ads_internal_zze));
    ...
    class C12671 implements zzdf {
        final /* synthetic */ zzc zzpr;

        C12671(zzc com_google_android_gms_ads_internal_zzc) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
        }
    ...
    protected void zza(zzeh com_google_android_gms_internal_zzeh) {
        com_google_android_gms_internal_zzeh.zza("/trackActiveViewUnit", new C12671(this));
    }
    ...
    protected void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C04612(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
        ...
        if (!com_google_android_gms_internal_zzif_zza.zzLe.zzHT || com_google_android_gms_internal_zzif_zza.zzLe.zzum) {
            zzir.zzMc.post(new C04643(this, com_google_android_gms_internal_zzif_zza, com_google_android_gms_internal_zzcb));
            return;
        }
        this.zzpj.zzrL = 0;
