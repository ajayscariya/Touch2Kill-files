...
public class GoogleCloudMessaging {
    ...
    class C04891 extends Handler {
        ...
        C04891(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaLU = new Messenger(new C04891(this, Looper.getMainLooper()));
    }
    ...
    private String zzdZ(String str) {
        ...
        return InstanceID.getInstance(this.context).zzyB().zzi(XMLConstants.NULL_NS_URI, str, INSTANCE_ID_SCOPE);
    }
