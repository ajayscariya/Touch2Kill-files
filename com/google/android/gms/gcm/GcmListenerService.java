...
public abstract class GcmListenerService extends Service {
    ...
    class C04871 implements Runnable {
        ...
        C04871(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C04882 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaLA;

        C04882(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaLA = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    private void zzn(Intent intent) {
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C04871(this, intent));
        } else {
            new C04882(this, intent).execute(new Void[0]);
        }
    }
