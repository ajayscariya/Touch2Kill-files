...
class zzjt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzjp {
    ...
    class C05821 implements Runnable {
        ...
        C05821(zzjt com_google_android_gms_internal_zzjt) {
    ...
    protected zzjt(zza com_google_android_gms_internal_zzjt_zza, AdSizeParcel adSizeParcel, boolean z, boolean z2, zzan com_google_android_gms_internal_zzan, VersionInfoParcel versionInfoParcel, zzcb com_google_android_gms_internal_zzcb, com.google.android.gms.ads.internal.zzd com_google_android_gms_ads_internal_zzd) {
        ...
        this.zzNX = true;
        this.zzEY = XMLConstants.NULL_NS_URI;
        this.zzDD = -1;
        this.zzDC = -1;
        this.zzDF = -1;
        this.zzDG = -1;
    ...
    public void destroy() {
        synchronized (this.zzpV) {
            ...
            zzit();
            this.zzNT = true;
            zzin.m4736v("Initiating WebView self destruct sequence in 3...");
            this.zzNQ.zzii();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzin.m4736v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzfr() {
        ...
        hashMap.put(OutputKeys.VERSION, this.zzpT.afmaVersion);
        zza("onshow", hashMap);
    }
    ...
    public void zzhZ() {
        synchronized (this.zzpV) {
            zzin.m4736v("Destroying WebView!");
            zzir.zzMc.post(new C05821(this));
        }
    }
