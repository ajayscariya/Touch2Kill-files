...
import com.google.android.gms.C0434R;
...
public class zzfm extends zzfs {
    ...
    class C05421 implements OnClickListener {
        ...
        C05421(zzfm com_google_android_gms_internal_zzfm) {
    ...
    class C05432 implements OnClickListener {
        ...
        C05432(zzfm com_google_android_gms_internal_zzfm) {
            this.zzCZ = com_google_android_gms_internal_zzfm;
        }
    ...
    private String zzaj(String str) {
        return TextUtils.isEmpty((CharSequence) this.zzxA.get(str)) ? XMLConstants.NULL_NS_URI : (String) this.zzxA.get(str);
    }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzL.setTitle(zzr.zzbF().zzd(C0434R.string.create_calendar_title, "Create calendar event"));
            zzL.setMessage(zzr.zzbF().zzd(C0434R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzL.setPositiveButton(zzr.zzbF().zzd(C0434R.string.accept, XIncludeHandler.HTTP_ACCEPT), new C05421(this));
            zzL.setNegativeButton(zzr.zzbF().zzd(C0434R.string.decline, "Decline"), new C05432(this));
            zzL.create().show();
        } else {
