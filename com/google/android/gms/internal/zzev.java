...
public class zzev implements zzem {
    ...
    class C05311 implements Runnable {
        ...
        C05311(zzev com_google_android_gms_internal_zzev, zzes com_google_android_gms_internal_zzes) {
            ...
            for (String str : com_google_android_gms_internal_zzen.zzBB) {
                ...
                synchronized (this.zzpV) {
                    ...
                    if (com_google_android_gms_internal_zzes.zzCq != null) {
                        zzir.zzMc.post(new C05311(this, com_google_android_gms_internal_zzes));
                    }
                }
            }
        }
