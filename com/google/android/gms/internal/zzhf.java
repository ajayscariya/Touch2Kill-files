...
public final class zzhf {
    ...
    class C13611 implements zzdf {
        final /* synthetic */ zzhf zzJm;

        C13611(zzhf com_google_android_gms_internal_zzhf) {
    ...
    class C13622 implements zzdf {
        final /* synthetic */ zzhf zzJm;

        C13622(zzhf com_google_android_gms_internal_zzhf) {
            this.zzJm = com_google_android_gms_internal_zzhf;
        }
            ...
            synchronized (this.zzJm.zzpV) {
                ...
                if (this.zzJm.zzEY.equals(com_google_android_gms_internal_zzhi.getRequestId())) {
                    ...
                    if (url.contains("%40mediation_adapters%40")) {
                        ...
                        zzin.m4736v("Ad request URL modified to " + replaceAll);
                    }
                    this.zzJm.zzJi.zzg(com_google_android_gms_internal_zzhi);
                    return;
                }
    ...
    public zzhf(String str, String str2) {
        ...
        this.zzJi = new zzjd();
        this.zzJk = new C13611(this);
        this.zzJl = new C13622(this);
        this.zzJh = str2;
        this.zzEY = str;
    }
