...
public class zzjq extends WebViewClient {
    ...
    class C05811 implements Runnable {
        ...
        C05811(zzjq com_google_android_gms_internal_zzjq) {
    ...
    private String zzaN(String str) {
        ...
        return parse.getHost() != null ? parse.getHost() : XMLConstants.NULL_NS_URI;
    }
    ...
    public final void onLoadResource(WebView webView, String url) {
        zzin.m4736v("Loading resource: " + url);
    ...
    public final void onPageFinished(WebView webView, String url) {
        synchronized (this.zzpV) {
            if (this.zzNH) {
                zzin.m4736v("Blank page loaded, 1...");
                this.zzpD.zzhZ();
                return;
            }
            this.zzNI = true;
    ...
    public boolean shouldOverrideKeyEvent(WebView view, KeyEvent event) {
        switch (event.getKeyCode()) {
            case C0866R.styleable.Theme_panelMenuListWidth /*79*/:
            case C0866R.styleable.Theme_colorControlNormal /*85*/:
            case C0866R.styleable.Theme_colorControlActivated /*86*/:
            case C0866R.styleable.Theme_colorControlHighlight /*87*/:
            case C0866R.styleable.Theme_colorButtonNormal /*88*/:
            case C0866R.styleable.Theme_colorSwitchThumbNormal /*89*/:
            case C0866R.styleable.Theme_controlBackground /*90*/:
            case C0866R.styleable.Theme_alertDialogStyle /*91*/:
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String url) {
        zzin.m4736v("AdWebView shouldOverrideUrlLoading: " + url);
        Uri parse = Uri.parse(url);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzfo() {
        synchronized (this.zzpV) {
            this.zzND = false;
            this.zzsz = true;
            zzir.runOnUiThread(new C05811(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzQ(2)) {
                zzin.m4736v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    zzin.m4736v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdf zza : list) {
        ...
        zzin.m4736v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzii() {
        synchronized (this.zzpV) {
            zzin.m4736v("Loading blank page in WebView, 2...");
            this.zzNH = true;
