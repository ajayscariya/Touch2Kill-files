...
public class zzbf extends Thread {
    ...
    class C04991 implements Runnable {
        ...
        C04991(zzbf com_google_android_gms_internal_zzbf, View view) {
    ...
    class C05012 implements Runnable {
        ...
        class C05001 implements ValueCallback<String> {
            final /* synthetic */ C05012 zztl;

            C05001(C05012 c05012) {
                this.zztl = c05012;
            }
        ...
        C05012(zzbf com_google_android_gms_internal_zzbf, zzbc com_google_android_gms_internal_zzbc, WebView webView, boolean z) {
            this.zztg = com_google_android_gms_internal_zzbf;
            this.zzti = com_google_android_gms_internal_zzbc;
            this.zztj = webView;
            this.zztk = z;
            this.zzth = new C05001(this);
        }
        ...
        public void run() {
            if (this.zztj.getSettings().getJavaScriptEnabled()) {
                try {
                    ...
                    this.zzth.onReceiveValue(XMLConstants.NULL_NS_URI);
                }
            }
        }
    }
    ...
    boolean zza(WebView webView, zzbc com_google_android_gms_internal_zzbc, boolean z) {
        ...
        com_google_android_gms_internal_zzbc.zzcC();
        webView.post(new C05012(this, com_google_android_gms_internal_zzbc, webView, z));
        return true;
    }
    ...
    boolean zze(View view) {
        ...
        view.post(new C04991(this, view));
        return true;
    }
