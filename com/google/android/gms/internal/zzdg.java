...
public class zzdg implements zzdf {
    ...
    class C05091 implements Runnable {
        ...
        class C05081 implements Runnable {
            ...
            final /* synthetic */ C05091 zzzo;

            C05081(C05091 c05091, JSONObject jSONObject) {
                this.zzzo = c05091;
        ...
        C05091(zzdg com_google_android_gms_internal_zzdg, Map map, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void run() {
            ...
            if (zzQ == null) {
                com.google.android.gms.ads.internal.util.client.zzb.m1157e("Response should not be null.");
            } else {
                zzir.zzMc.post(new C05081(this, zzQ));
            }
        }
    }
    ...
    public JSONObject zzQ(String str) {
        try {
            ...
            Object obj = XMLConstants.NULL_NS_URI;
            try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m1157e("The request is not a valid JSON.");
            try {
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        zziq.zza(new C05091(this, map, com_google_android_gms_internal_zzjp));
    }
