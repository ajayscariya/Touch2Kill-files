...
public final class zzbt {
    ...
    static class C05051 implements Callable<Void> {
        final /* synthetic */ Context zzxh;

        C05051(Context context) {
            this.zzxh = context;
        }
    ...
    static {
        ...
        zzvT = zzbp.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) HapticContentSDK.f1228b04440444044404440444);
        zzvU = zzbp.zza(0, "gads:video:metric_reporting_enabled", Boolean.valueOf(false));
        zzvV = zzbp.zza(0, "gads:video:metric_frame_hash_times", XMLConstants.NULL_NS_URI);
