...
public class zzv implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) throws IOException {
            ...
            if (com_google_android_gms_internal_zzv_zza.zzb.equals(XMLConstants.NULL_NS_URI)) {
        ...
        public boolean zza(OutputStream outputStream) {
            try {
                ...
                zzv.zza(outputStream, this.zzb == null ? XMLConstants.NULL_NS_URI : this.zzb);
    ...
    static String zzd(InputStream inputStream) throws IOException {
        return new String(zza(inputStream, (int) zzc(inputStream)), Defaults.Encoding);
    }
