...
public class zzgw implements Callable<zzif> {
    ...
    class C05552 implements Runnable {
        ...
        C05552(zzgw com_google_android_gms_internal_zzgw, zzjd com_google_android_gms_internal_zzjd, String str) {
    ...
    class C13531 implements zzdf {
        final /* synthetic */ zzed zzGM;
        final /* synthetic */ zzb zzGN;
        final /* synthetic */ zzjd zzGO;
        final /* synthetic */ zzgw zzGP;

        C13531(zzgw com_google_android_gms_internal_zzgw, zzed com_google_android_gms_internal_zzed, zzb com_google_android_gms_internal_zzgw_zzb, zzjd com_google_android_gms_internal_zzjd) {
            this.zzGP = com_google_android_gms_internal_zzgw;
    ...
    class C13543 implements zzdf {
        final /* synthetic */ zzgw zzGP;
        final /* synthetic */ zzf zzGS;

        C13543(zzgw com_google_android_gms_internal_zzgw, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzGP = com_google_android_gms_internal_zzgw;
    ...
    class C13554 implements com.google.android.gms.internal.zzjf.zza<List<zzc>, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgw zzGP;
        ...
        C13554(zzgw com_google_android_gms_internal_zzgw, String str, Integer num, Integer num2, int i, int i2, int i3) {
            this.zzGP = com_google_android_gms_internal_zzgw;
            this.zzGT = str;
            this.zzGU = num;
            this.zzGV = num2;
    ...
    class C13565 implements com.google.android.gms.internal.zziw.zza<zzc> {
        final /* synthetic */ String zzDr;
        final /* synthetic */ zzgw zzGP;
        final /* synthetic */ boolean zzGZ;
        final /* synthetic */ double zzHa;

        C13565(zzgw com_google_android_gms_internal_zzgw, boolean z, double d, String str) {
            this.zzGP = com_google_android_gms_internal_zzgw;
            this.zzGZ = z;
            this.zzHa = d;
            this.zzDr = str;
    ...
    private com.google.android.gms.ads.internal.formats.zzh.zza zza(zzed com_google_android_gms_internal_zzed, zza com_google_android_gms_internal_zzgw_zza, JSONObject jSONObject) throws ExecutionException, InterruptedException, JSONException {
        ...
        if (zza == null) {
            com.google.android.gms.ads.internal.util.client.zzb.m1157e("Failed to retrieve ad assets.");
            return null;
        }
    ...
    private zzjg<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzje(new zzc(null, Uri.parse(string), optDouble)) : this.zzGG.zza(string, new C13565(this, z, optDouble, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzed com_google_android_gms_internal_zzed) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdf c13543 = new C13543(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgw_zzb.zzHb = c13543;
            com_google_android_gms_internal_zzed.zza("/nativeAdCustomClick", c13543);
        }
    }
    ...
    private JSONObject zzb(zzed com_google_android_gms_internal_zzed) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgw_zzb = new zzb(this);
        zzdf c13531 = new C13531(this, com_google_android_gms_internal_zzed, com_google_android_gms_internal_zzgw_zzb, com_google_android_gms_internal_zzjd);
        com_google_android_gms_internal_zzgw_zzb.zzHb = c13531;
        com_google_android_gms_internal_zzed.zza("/nativeAdPreProcess", c13531);
    ...
    protected zza zze(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzjd com_google_android_gms_internal_zzjd = new zzjd();
            zzir.zzMc.post(new C05552(this, com_google_android_gms_internal_zzjd, string2));
            if (com_google_android_gms_internal_zzjd.get(zzGF, TimeUnit.MILLISECONDS) != null) {
                return new zzgz(z);
            }
            com.google.android.gms.ads.internal.util.client.zzb.m1157e("No handler for custom template: " + jSONObject.getString("custom_template_id"));
        } else {
            zzF(0);
        }
        return null;
    ...
    public zzjg<com.google.android.gms.ads.internal.formats.zza> zzf(JSONObject jSONObject) throws JSONException {
        ...
        return zzjf.zza(zzjf.zzl(arrayList), new C13554(this, optString, zzb2, zzb, optInt, optInt3, optInt2));
    }
