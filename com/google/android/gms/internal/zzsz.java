...
public interface zzsz {
    ...
    public static final class zzb extends zzso<zzb> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.zzbuN.equals(XMLConstants.NULL_NS_URI)) {
                output.zzn(2, this.zzbuN);
            }
            if (!this.version.equals(XMLConstants.NULL_NS_URI)) {
        ...
        public zzb zzJD() {
            this.zzbuM = 0;
            this.zzbuN = XMLConstants.NULL_NS_URI;
            this.version = XMLConstants.NULL_NS_URI;
            this.zzbuj = null;
            this.zzbuu = -1;
            return this;
        }
        ...
        protected int zzz() {
            ...
            return !this.version.equals(XMLConstants.NULL_NS_URI) ? zzz + zzsn.zzo(3, this.version) : zzz;
        }
    }
    ...
    public static final class zzd extends zzso<zzd> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.tag.equals(XMLConstants.NULL_NS_URI)) {
            ...
            if (!this.zzbvc.equals(XMLConstants.NULL_NS_URI)) {
        ...
        public zzd zzJF() {
            ...
            this.zzbuS = 0;
            this.zzbuT = 0;
            this.tag = XMLConstants.NULL_NS_URI;
            this.zzbuU = 0;
            this.zzob = 0;
            this.zzbuV = false;
            this.zzbuW = zze.zzJG();
            ...
            this.zzbvb = null;
            this.zzbvc = XMLConstants.NULL_NS_URI;
            this.zzbvd = 180000;
            this.zzbve = null;
            ...
            while (true) {
                ...
                switch (zzIX) {
                    ...
                    case MetaData.DEFAULT_HTML_3D_PROBABILITY_3D /*50*/:
                        ...
                        continue;
                    case C0866R.styleable.Theme_toolbarStyle /*58*/:
                        if (this.zzbvb == null) {
                            this.zzbvb = new zza();
                        }
                    ...
                    case C0866R.styleable.Theme_textAppearanceSearchResultSubtitle /*66*/:
                        ...
                        continue;
                    case C0866R.styleable.Theme_dropDownListViewStyle /*74*/:
                        if (this.zzbuX == null) {
                            this.zzbuX = new zzb();
                        }
                    ...
                    case C0866R.styleable.Theme_colorButtonNormal /*88*/:
                        ...
                        continue;
                    case C0866R.styleable.Theme_buttonBarPositiveButtonStyle /*96*/:
                        this.zzob = com_google_android_gms_internal_zzsm.zzJb();
                        continue;
                    case C0866R.styleable.Theme_ratingBarStyle /*106*/:
    ...
    public static final class zze extends zzso<zze> {
        ...
        public void writeTo(zzsn output) throws IOException {
            if (!this.key.equals(XMLConstants.NULL_NS_URI)) {
                output.zzn(1, this.key);
            }
            if (!this.value.equals(XMLConstants.NULL_NS_URI)) {
        ...
        public zze zzJH() {
            this.key = XMLConstants.NULL_NS_URI;
            this.value = XMLConstants.NULL_NS_URI;
            this.zzbuj = null;
            this.zzbuu = -1;
            return this;
        }
        ...
        protected int zzz() {
            ...
            return !this.value.equals(XMLConstants.NULL_NS_URI) ? zzz + zzsn.zzo(2, this.value) : zzz;
        }
    }
}
