...
public class zzc extends Thread {
    ...
    class C05071 implements Runnable {
        ...
        C05071(zzc com_google_android_gms_internal_zzc, zzk com_google_android_gms_internal_zzk) {
                ...
                if (com_google_android_gms_internal_zzk.isCanceled()) {
                    ...
                    if (zza == null) {
                        ...
                        if (zza.zzc()) {
                            ...
                            com_google_android_gms_internal_zzk.zza(zza);
                            zza2.zzai = true;
                            this.zzk.zza(com_google_android_gms_internal_zzk, zza2, new C05071(this, com_google_android_gms_internal_zzk));
                        } else {
