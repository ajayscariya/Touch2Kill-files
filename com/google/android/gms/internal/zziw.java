...
public class zziw {
    ...
    static class C13631 implements zza {
        C13631() {
        }
    ...
    class C13642 implements com.google.android.gms.internal.zzm.zza {
        final /* synthetic */ zzc zzMA;
        final /* synthetic */ zziw zzMB;
        final /* synthetic */ String zzzP;

        C13642(zziw com_google_android_gms_internal_zziw, String str, zzc com_google_android_gms_internal_zziw_zzc) {
    ...
    private static class zzb<T> extends zzk<InputStream> {
        ...
        class C13651 implements com.google.android.gms.internal.zzm.zza {
            final /* synthetic */ com.google.android.gms.internal.zzm.zzb zzME;
            final /* synthetic */ zza zzMF;

            C13651(com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, zza com_google_android_gms_internal_zziw_zza) {
        ...
        public zzb(String str, zza<T> com_google_android_gms_internal_zziw_zza_T, com.google.android.gms.internal.zzm.zzb<T> com_google_android_gms_internal_zzm_zzb_T) {
            super(0, str, new C13651(com_google_android_gms_internal_zzm_zzb_T, com_google_android_gms_internal_zziw_zza_T));
    ...
    class C15293 extends zzab {
        final /* synthetic */ zziw zzMB;
        final /* synthetic */ Map zzMC;

        C15293(zziw com_google_android_gms_internal_zziw, String str, com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, com.google.android.gms.internal.zzm.zza com_google_android_gms_internal_zzm_zza, Map map) {
            this.zzMB = com_google_android_gms_internal_zziw;
            this.zzMC = map;
    ...
    public zzjg<String> zzb(String str, Map<String, String> map) {
        Object com_google_android_gms_internal_zziw_zzc = new zzc();
        zzMy.zze(new C15293(this, str, com_google_android_gms_internal_zziw_zzc, new C13642(this, str, com_google_android_gms_internal_zziw_zzc), map));
        return com_google_android_gms_internal_zziw_zzc;
    }
}
