...
public class zziu {
    ...
    class C05751 implements OnClickListener {
        ...
        C05751(zziu com_google_android_gms_internal_zziu, String str) {
    ...
    class C05762 implements OnClickListener {
        ...
        C05762(zziu com_google_android_gms_internal_zziu) {
            this.zzMm = com_google_android_gms_internal_zziu;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C05751(this, zzaG));
            builder.setNegativeButton("Close", new C05762(this));
            builder.create().show();
            return;
        }
