...
public final class zzmh implements zzmg {
    ...
    class C15571 extends zza {
        final /* synthetic */ zzmh zzamB;

        C15571(zzmh com_google_android_gms_internal_zzmh, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzf(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C15571(this, googleApiClient));
    }
}
