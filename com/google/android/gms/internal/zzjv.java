...
public class zzjv extends WebChromeClient {
    ...
    static class C05831 implements OnCancelListener {
        final /* synthetic */ JsResult zzOh;

        C05831(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C05842 implements OnClickListener {
        final /* synthetic */ JsResult zzOh;

        C05842(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C05853 implements OnClickListener {
        final /* synthetic */ JsResult zzOh;

        C05853(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C05864 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzOi;

        C05864(JsPromptResult jsPromptResult) {
    ...
    static class C05875 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzOi;

        C05875(JsPromptResult jsPromptResult) {
            this.zzOi = jsPromptResult;
        }
    ...
    static class C05886 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzOi;
        final /* synthetic */ EditText zzOj;

        C05886(JsPromptResult jsPromptResult, EditText editText) {
            this.zzOi = jsPromptResult;
            this.zzOj = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C05853(jsResult)).setNegativeButton(17039360, new C05842(jsResult)).setOnCancelListener(new C05831(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C05886(jsPromptResult, editText)).setNegativeButton(17039360, new C05875(jsPromptResult)).setOnCancelListener(new C05864(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C05897.zzOk[consoleMessage.messageLevel().ordinal()]) {
