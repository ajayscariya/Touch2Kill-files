...
public class zzfp extends zzfs {
    ...
    class C05451 implements OnClickListener {
        ...
        C05451(zzfp com_google_android_gms_internal_zzfp, String str, String str2) {
    ...
    class C05462 implements OnClickListener {
        ...
        C05462(zzfp com_google_android_gms_internal_zzfp) {
            this.zzDt = com_google_android_gms_internal_zzfp;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setTitle(zzr.zzbF().zzd(C0434R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzr.zzbF().zzd(C0434R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzr.zzbF().zzd(C0434R.string.accept, XIncludeHandler.HTTP_ACCEPT), new C05451(this, str, zzal));
                    zzL.setNegativeButton(zzr.zzbF().zzd(C0434R.string.decline, "Decline"), new C05462(this));
                    zzL.create().show();
                    return;
                }
