...
public class zzg implements zzk {
    ...
    class C12811 extends zza {
        final /* synthetic */ zzg zzahl;

        C12811(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
    ...
    class C12822 extends zza {
        final /* synthetic */ zzg zzahl;

        C12822(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
            this.zzahl = com_google_android_gms_common_api_internal_zzg;
            super(com_google_android_gms_common_api_internal_zzk);
        }
    ...
    public void connect() {
        if (this.zzahk) {
            this.zzahk = false;
            this.zzahj.zza(new C12822(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzahj.zza(new C12811(this, this));
        }
        return t;
    }
