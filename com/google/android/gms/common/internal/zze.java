...
public abstract class zze {
    ...
    static class C12901 extends zze {
        C12901() {
        }
    ...
    static class C12912 extends zze {
        final /* synthetic */ char zzakU;
        final /* synthetic */ char zzakV;

        C12912(char c, char c2) {
            this.zzakU = c;
            this.zzakV = c2;
        }
    ...
    static class C12923 extends zze {
    ...
    static class C12934 extends zze {
        final /* synthetic */ char zzakX;
        final /* synthetic */ char zzakY;

        C12934(char c, char c2) {
            this.zzakX = c;
            this.zzakY = c2;
        }
    ...
    static class C12945 extends zze {
        C12945() {
        }
    ...
    static class C12956 extends zze {
        C12956() {
        }
    ...
    static class C12967 extends zze {
        C12967() {
        }
    ...
    static class C12978 extends zze {
        C12978() {
        }
    ...
    static class C12989 extends zze {
        C12989() {
        }
    ...
    public static zze zza(CharSequence charSequence) {
        switch (charSequence.length()) {
            ...
            case DurationDV.DAYTIMEDURATION_TYPE /*2*/:
                return new C12912(charSequence.charAt(0), charSequence.charAt(1));
            default:
                char[] toCharArray = charSequence.toString().toCharArray();
                Arrays.sort(toCharArray);
                return new C12923(toCharArray);
        }
    }
