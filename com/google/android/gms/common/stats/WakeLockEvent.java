...
public final class WakeLockEvent extends zzf implements SafeParcelable {
    ...
    public String zzrO() {
        return "\t" + zzrR() + "\t" + zzrT() + "\t" + (zzrU() == null ? XMLConstants.NULL_NS_URI : TextUtils.join(",", zzrU())) + "\t" + zzrV() + "\t" + (zzrS() == null ? XMLConstants.NULL_NS_URI : zzrS()) + "\t" + (zzrW() == null ? XMLConstants.NULL_NS_URI : zzrW()) + "\t" + zzrX();
    }
