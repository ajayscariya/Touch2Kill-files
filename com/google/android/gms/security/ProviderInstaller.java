...
public class ProviderInstaller {
    ...
    static class C05961 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzbgR;
        final /* synthetic */ Context zzxh;

        C05961(Context context, ProviderInstallListener providerInstallListener) {
            this.zzxh = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener listener) {
        ...
        new C05961(context, listener).execute(new Void[0]);
    }
