...
public class InstanceIDListenerService extends Service {
    ...
    class C04931 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C04931(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C04942 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C04942(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaMW = new MessengerCompat(new C04931(this, Looper.getMainLooper()));
        this.zzaMX = new C04942(this);
    }
    ...
    public void zzp(Intent intent) {
        ...
        if (intent.getStringExtra(GCMConstants.EXTRA_ERROR) == null && intent.getStringExtra(GCMConstants.EXTRA_REGISTRATION_ID) == null) {
            ...
            if (intent.getStringExtra(GCMConstants.EXTRA_UNREGISTERED) != null) {
                ...
                if (stringExtra == null) {
                    stringExtra = XMLConstants.NULL_NS_URI;
                }
