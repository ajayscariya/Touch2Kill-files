...
public class InstanceID {
    ...
    protected InstanceID(Context context, String subtype, Bundle options) {
        this.zzaMT = XMLConstants.NULL_NS_URI;
    ...
    public static synchronized InstanceID zza(Context context, Bundle bundle) {
        ...
        synchronized (InstanceID.class) {
            String string = bundle == null ? XMLConstants.NULL_NS_URI : bundle.getString("subtype");
            String str = string == null ? XMLConstants.NULL_NS_URI : string;
    ...
    public void zzb(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("subtype", XMLConstants.NULL_NS_URI.equals(this.zzaMT) ? str : this.zzaMT);
        String str3 = "X-subtype";
        if (!XMLConstants.NULL_NS_URI.equals(this.zzaMT)) {
            str = this.zzaMT;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString(GCMConstants.EXTRA_SENDER, str);
        String str3 = XMLConstants.NULL_NS_URI.equals(this.zzaMT) ? str : this.zzaMT;
