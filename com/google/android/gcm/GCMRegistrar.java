...
public final class GCMRegistrar {
    ...
    public static String getRegistrationId(Context context) {
        ...
        String registrationId = prefs.getString(PROPERTY_REG_ID, XMLConstants.NULL_NS_URI);
    ...
    public static String clearRegistrationId(Context context) {
        return setRegistrationId(context, XMLConstants.NULL_NS_URI);
    }

    static String setRegistrationId(Context context, String regId) {
        SharedPreferences prefs = getGCMPreferences(context);
        String oldRegistrationId = prefs.getString(PROPERTY_REG_ID, XMLConstants.NULL_NS_URI);
