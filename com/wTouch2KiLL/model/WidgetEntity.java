...
public class WidgetEntity implements Serializable {
    ...
    /* renamed from: com.wTouch2KiLL.model.WidgetEntity.1 */
    static /* synthetic */ class C09331 {
        static final /* synthetic */ int[] $SwitchMap$com$wTouch2KiLL$model$WidgetEntity$DefaultWidgetType;

        static {
            $SwitchMap$com$wTouch2KiLL$model$WidgetEntity$DefaultWidgetType = new int[DefaultWidgetType.values().length];
            try {
                $SwitchMap$com$wTouch2KiLL$model$WidgetEntity$DefaultWidgetType[DefaultWidgetType.PAUSED.ordinal()] = 1;
    ...
    public static WidgetEntity createDefaultWidget(DefaultWidgetType type) {
        WidgetEntity tmpEntity = new WidgetEntity();
        switch (C09331.$SwitchMap$com$wTouch2KiLL$model$WidgetEntity$DefaultWidgetType[type.ordinal()]) {
            case MainNavigationActivity.REQUEST_CODE /*1*/:
                tmpEntity._id = "pausedwidget_0";
                tmpEntity._name = "PausedWidget";
                tmpEntity._link = Factory.getInstance().getMainNavigationActivity().getResources().getString(C0866R.string.pausedContentUrl) + Factory.getInstance().getMainNavigationActivity().getConfig().getWidgetName();
                tmpEntity._width = 300;
                tmpEntity._height = 300;
                tmpEntity._updateTime = 0;
                tmpEntity._tabName = XMLConstants.NULL_NS_URI;
                tmpEntity._tabIcon = XMLConstants.NULL_NS_URI;
                tmpEntity._injectJS = XMLConstants.NULL_NS_URI;
                tmpEntity._loadingCurtainType = LoadingCurtainType.NONE;
                tmpEntity._userAgent = XMLConstants.NULL_NS_URI;
                tmpEntity._tabId = "-1";
                return tmpEntity;
            default:
                return null;
