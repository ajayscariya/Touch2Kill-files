...
import com.wTouch2KiLL.ads.BottomBannerLayout.BannerPosition;
...
public class XMLConfigurationHandler extends DefaultHandler {
    ...
    XMLConfigurationHandler(WebWidgetConfiguration webWidgetConfiguration, WidgetsController widgetsController) {
        this.current2ndParentTag = XMLConstants.NULL_NS_URI;
        this.currentParentTag = XMLConstants.NULL_NS_URI;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (localName.equalsIgnoreCase(TAG_FULL_SCREEN_MODE)) {
            ...
            } else if (button.equalsIgnoreCase("downloads_list")) {
                this.webWidgetConfiguration.addUrlBarMenuButton(new UrlBarMenuButton(UrlBarMenuButtonTypes.DOWNLOADS_LIST));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (localName.equalsIgnoreCase(TAG_FULL_SCREEN_MODE)) {
            ...
            if (!localName.equalsIgnoreCase(TAG_REGISTERED_URL)) {
                if (!localName.equalsIgnoreCase(TAG_USAGE)) {
                    if (!localName.equalsIgnoreCase(TAG_LOCATON_URL)) {
                        if (!localName.equalsIgnoreCase(TAG_CONTENT)) {
                            if (!localName.equalsIgnoreCase(TAG_CONTENT_PROTECTION)) {
                                if (!localName.equalsIgnoreCase(TAG_AFFILIATE)) {
                                    if (!localName.equalsIgnoreCase(TAG_URL_BAR_MENU_ITEMS)) {
                                        if (this.current2ndParentTag.equalsIgnoreCase(TAG_FULL_SCREEN_MODE)) {
                                                ...
                                                if (!localName.equalsIgnoreCase(TAG_ID)) {
                                                    if (!localName.equalsIgnoreCase(TAG_NAME)) {
                                                        if (!localName.equalsIgnoreCase(TAG_LINK)) {
                                                            if (!localName.equalsIgnoreCase(TAG_UPDATE)) {
                                                                if (!localName.equalsIgnoreCase(TAG_CONTENT_WIDTH)) {
                                                                    if (!localName.equalsIgnoreCase(TAG_CONTENT_HEIGHT)) {
                                                                        if (!localName.equalsIgnoreCase(TAG_TAB_NAME)) {
                                                                            if (!localName.equalsIgnoreCase(TAG_TAB_ICON)) {
                                                                                if (localName.equalsIgnoreCase(TAG_INJECT_JS)) {
                                                                                    ...
                                                                                    if (!localName.equalsIgnoreCase(TAG_LOADING_CURTAIN)) {
                                                                                        if (!localName.equalsIgnoreCase(TAG_USER_AGENT)) {
                                                                                            if (localName.equalsIgnoreCase(TAG_TAB_ID)) {
                                                                                                this._currentWidgetEntity.setTabId(this.builder.toString());
                                                                                            } else {
                                                                                                if (localName.equalsIgnoreCase(TAG_SHOW_AS_TAB)) {
                                                                                                    this._currentWidgetEntity.setShowAsTab(this.builder.toString().equalsIgnoreCase(SchemaSymbols.ATTVAL_TRUE));
                                                                                                }
                                                                                            }
                                                                                        } else if (this._currentWidgetEntity != null) {
                                                                                        ...
                                                                                        } else if (typeName.compareToIgnoreCase("default") == 0) {
                                            ...
                                            if (localName.equalsIgnoreCase(TAG_ID)) {
                                                this.webWidgetConfiguration.setApplicationId(Integer.parseInt(this.builder.toString().replaceAll(LineSeparator.Web, XMLConstants.NULL_NS_URI).replaceAll("\t", XMLConstants.NULL_NS_URI)));
                                            } else {
                                                if (localName.equalsIgnoreCase(TAG_WIDGET_NAME)) {
                                                    ...
                                                    if (localName.equalsIgnoreCase(TAG_LOGIN)) {
                                                        ...
                                                        if (localName.equalsIgnoreCase(TAG_PASSWORD)) {
                                                            this.webWidgetConfiguration.setHttpAccessPassword(this.builder.toString());
                                                        }
                                                    }
                                                } else {
                                                    String value;
                                                    if (localName.equalsIgnoreCase(TAG_USER_INTERFACE)) {
                                                        ...
                                                        if (localName.equalsIgnoreCase(TAG_BANNER_POSITION)) {
                                                            value = this.builder.toString();
                                                            if (value.equals("top")) {
                                                            ...
                                                            if (!localName.equalsIgnoreCase(TAG_RATE_ITEM_VISIBILITY)) {
                                                                if (!localName.equalsIgnoreCase(TAG_ACCEPT_COOKIE)) {
                                                                    if (!localName.equalsIgnoreCase(TAG_BLOCK_APP_FROM_SLEEP)) {
                                                                        if (!localName.equalsIgnoreCase(TAG_SHOW_REFRESH_MENU_ITEM)) {
                                                                            if (!localName.equalsIgnoreCase(TAG_SHOW_SHARE_MENU_ITEM)) {
                                                                                if (!localName.equalsIgnoreCase(TAG_SHOW_DOWNLOADS_LIST)) {
                                                                                    if (!localName.equalsIgnoreCase(TAG_SHOW_ABOUT_MENU_ITEM)) {
                                                                                        if (!localName.equalsIgnoreCase(TAG_SHOW_EXIT_MENU_ITEM)) {
                                                                                            if (!localName.equalsIgnoreCase(TAG_SHOW_SETTINGS)) {
                                                                                                if (localName.equalsIgnoreCase(SHARE_EXTRA_LINK)) {
                                                                                                    this.webWidgetConfiguration.setShareExtraLink(this.builder.toString());
                                                                                                } else {
                                                                                                    if (localName.equalsIgnoreCase(TAG_ENABLE_FULLSCREEN_BANNER)) {
                                                                                                        this.webWidgetConfiguration.setFullscreenBannerEnabled(this.builder.toString().equalsIgnoreCase(SchemaSymbols.ATTVAL_TRUE));
                                                                                                    } else {
                                                                                                        if (localName.equalsIgnoreCase(TAG_ENABLE_ON_EXIT_FULLSCREEN_BANNER)) {
                                                                                                            ...
                                                                                                            if (localName.equalsIgnoreCase(TAG_SHOW_STARTUP_CONFIRMATION_DIALOG)) {
                                                                                                                ...
                                                                                                                if (localName.equalsIgnoreCase(TAG_IS_ABOUT_SCREEN_ENABLED)) {
                                                                                                                    ...
                                                                                                                    if (localName.equalsIgnoreCase(TAG_THEME)) {
                                                                                                                        ...
                                                                                                                        if (localName.equalsIgnoreCase(TAG_ENABLE_URL_BAR)) {
                                                                                                                            ...
                                                                                                                            if (localName.equalsIgnoreCase(TAG_ENABLE_HIDE_URL_BAR)) {
                                                                                                                                UrlBarHide urlBarHide = UrlBarHide.ENABLED;
                                                                                                                                if (this.builder.toString().equalsIgnoreCase(SchemaSymbols.ATTVAL_FALSE)) {
                                                                                                                                    urlBarHide = UrlBarHide.DISABLED;
                                                                                                                                }
                                                                                                                                this.webWidgetConfiguration.setUrlBarHide(urlBarHide);
                                                                                                                            } else {
                                                                                                                                if (!localName.equalsIgnoreCase(TAG_SHOW_SEARCH_NOTICE)) {
                                                                                                                                    if (localName.equalsIgnoreCase(TAG_URL_BAR_STYLE)) {
                                                                                                                                        ...
                                                                                                                                        if (localName.equalsIgnoreCase(TAG_TABS_POSITION)) {
                                                                                                                                            ...
                                                                                                                                            if (localName.equalsIgnoreCase(TAG_ENABLE_HIDE_TAB_BAR)) {
                                                                                                                                                TabsEnabledHide tabsEnabledHide = TabsEnabledHide.ENABLED;
                                                                                                                                                if (this.builder.toString().equalsIgnoreCase(SchemaSymbols.ATTVAL_FALSE)) {
                                                                                                                                                    tabsEnabledHide = TabsEnabledHide.DISABLED;
                                                                                                                                                }
                                                                                                                                                this.webWidgetConfiguration.setTabsEnabledHide(tabsEnabledHide);
                                                                                                                                            } else {
                                                                                                                                                if (localName.equalsIgnoreCase(TAG_PUBLISHER_NAME)) {
                                                                                                                                                    ...
                                                                                                                                                    if (!localName.equalsIgnoreCase(TAG_IS_REDIRECT_ENABLED)) {
                                                                                                                                                        if (localName.equalsIgnoreCase(TAG_DOWNLOAD_ACTION)) {
                                                                                                                                                    ...
                                                                                                                                                    } else if (this.builder.toString().equalsIgnoreCase(SchemaSymbols.ATTVAL_FALSE)) {
