...
public class WebWidgetConfiguration implements Serializable {
    ...
    public String loadGuid(Context context) {
        this.appGuid = context.getSharedPreferences(MainNavigationActivity.PREFS_NAME, 0).getString(GUID_KEY_NAME, XMLConstants.NULL_NS_URI);
    ...
    public Boolean loadPushAccount(Context context) {
        boolean z = false;
        this.pushAccount = context.getSharedPreferences(MainNavigationActivity.PREFS_NAME, 0).getString(PUSH_ACCOUNT_NAME, XMLConstants.NULL_NS_URI);
    ...
    public void setShowDownloadList(boolean showDownloadList) {
        this.showDownloadList = showDownloadList;
    }
    ...
    public void setShowSearchNotice(boolean showSearchNotice) {
        this.showSearchNotice = showSearchNotice;
    }
}
