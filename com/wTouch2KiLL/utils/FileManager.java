...
import com.wTouch2KiLL.VideoPlayerActivity;
...
public class FileManager {
    ...
    /* renamed from: com.wTouch2KiLL.utils.FileManager.1 */
    static class C09811 extends ArrayList<String> {
        C09811() {
            add("video/mpeg4");
            add("video/mp4");
            add("video/3gp");
    ...
    public static long downloadFile(String url, String mimetype, String contentDisposition, Context context) {
    ...
    public static File saveBitmapToGallery(String prefix, Bitmap bmp) {
        try {
            ...
            String date = XMLConstants.NULL_NS_URI + c.get(5) + c.get(2) + c.get(1) + c.get(11) + c.get(12) + c.get(13);
