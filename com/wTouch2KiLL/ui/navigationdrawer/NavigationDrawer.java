...
public class NavigationDrawer {
    ...
    /* renamed from: com.wTouch2KiLL.ui.navigationdrawer.NavigationDrawer.2 */
    class C09522 implements Runnable {
        C09522() {
        }
    ...
    /* renamed from: com.wTouch2KiLL.ui.navigationdrawer.NavigationDrawer.3 */
    class C09533 implements AnimationListener {
        C09533() {
        }
    ...
    /* renamed from: com.wTouch2KiLL.ui.navigationdrawer.NavigationDrawer.1 */
    class C15451 extends ActionBarDrawerToggle {
        C15451(Activity x0, DrawerLayout x1, int x2, int x3, int x4) {
    ...
    public NavigationDrawer(MainNavigationActivity activity) {
        ...
        if (activity != null) {
            ...
            this.mDrawerLayout = (DrawerLayout) this._activity.findViewById(C0866R.id.drawer_layout);
            this.mDrawerList = (ListView) this._activity.findViewById(C0866R.id.left_drawer);
            this.mDrawerList.setVisibility(8);
            this.mSliderHandle = (ImageView) this._activity.findViewById(C0866R.id.slider_handle);
            this._sliderHandleAnimation = AnimationUtils.loadAnimation(activity, C0866R.anim.slider_handle_animation);
            this._sliderHandleAnimation.setRepeatCount(-1);
            this._sliderHandleHideAnimation = AnimationUtils.loadAnimation(activity, C0866R.anim.slider_handle_hide_animation);
            this._userKnowsAboutDrawer = activity.getPreferences(0).getBoolean("userKnowsAboutDrawer", false);
            if (!this._userKnowsAboutDrawer) {
                showSliderHandle();
            }
            this.mDrawerToggle = new C15451(this._activity, this.mDrawerLayout, C0866R.drawable.icon, C0866R.string.drawer_open, C0866R.string.drawer_close);
            this._hideHandle.postDelayed(new C09522(), 20000);
    ...
    public void hideSliderHandle() {
        ...
        this._sliderHandleHideAnimation.setAnimationListener(new C09533());
