...
public class NetworkImageView extends ImageView {
    ...
    class C15121 implements ImageListener {
        ...
        class C01911 implements Runnable {
            ...
            C01911(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C15121.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C01911(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C15121(isInLayoutPass), maxWidth, maxHeight, scaleType);
        }
    }
