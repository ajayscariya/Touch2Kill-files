...
public class ImageLoader {
    ...
    class C11642 implements Listener<Bitmap> {
    ...
    class C11653 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C15111(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new C11642(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new C11653(cacheKey));
    }
