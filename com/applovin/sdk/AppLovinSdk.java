...
public abstract class AppLovinSdk {
    ...
    private static AppLovinSdk[] f368a;
    private static final Object f369b;

    static {
        f368a = new AppLovinSdk[0];
        f369b = new Object();
    }
    ...
    public static AppLovinSdk getInstance(String str, AppLovinSdkSettings appLovinSdkSettings, Context context) {
        ...
        synchronized (f369b) {
            if (f368a.length == 1 && f368a[0].getSdkKey().equals(str)) {
                appLovinSdk = f368a[0];
            } else {
                for (AppLovinSdk appLovinSdk2 : f368a) {
                ...
                try {
                    ...
                    Object obj = new AppLovinSdk[(f368a.length + 1)];
                    System.arraycopy(f368a, 0, obj, 0, f368a.length);
                    obj[f368a.length] = appLovinSdk2;
                    f368a = obj;
                } catch (Throwable th) {
