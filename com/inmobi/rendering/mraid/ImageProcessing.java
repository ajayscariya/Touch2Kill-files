...
public class ImageProcessing {
    private static final String f1978a;

    static {
        f1978a = ImageProcessing.class.getSimpleName();
    }

    public static String m2081a(Bitmap bitmap, Context context, int i) {
        OutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        bitmap.compress(CompressFormat.JPEG, i, byteArrayOutputStream);
        return Base64.encodeToString(byteArrayOutputStream.toByteArray(), 2);
    }

    public static String m2082a(Uri uri, Context context) {
    ...
    public static Bitmap m2080a(String str, Context context, int i, int i2) {
        int i3 = i * i2;
        try {
            ...
            Logger.m1744a(InternalLogLevel.INTERNAL, f1978a, "bitmap size - width: " + createScaledBitmap.getWidth() + ", height: " + createScaledBitmap.getHeight());
            return createScaledBitmap;
        } catch (IOException e) {
            Logger.m1744a(InternalLogLevel.INTERNAL, f1978a, e.getMessage());
            return null;
        }
    }
}
