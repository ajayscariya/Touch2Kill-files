...
public final class InMobiAdRequestStatus {
    ...
    static /* synthetic */ class C06301 {
        ...
        static {
            f1405a = new int[StatusCode.values().length];
            try {
                f1405a[StatusCode.INTERNAL_ERROR.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f1405a[StatusCode.NETWORK_UNREACHABLE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1405a[StatusCode.REQUEST_INVALID.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1405a[StatusCode.REQUEST_PENDING.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f1405a[StatusCode.REQUEST_TIMED_OUT.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f1405a[StatusCode.SERVER_ERROR.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f1405a[StatusCode.NO_FILL.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f1405a[StatusCode.AD_ACTIVE.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f1405a[StatusCode.EARLY_REFRESH_REQUEST.ordinal()] = 9;
    ...
    private void setMessage() {
        switch (C06301.f1405a[this.mStatusCode.ordinal()]) {
