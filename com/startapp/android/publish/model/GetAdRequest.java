...
public class GetAdRequest extends BaseRequest {
    ...
    public void fillAdPreferences(Context context, AdPreferences adPreferences, Placement placement, String simpleToken) {
        this.placement = placement;
        if (MetaData.getInstance().getAdInformationConfig().m2831e().m2889a(context) && adPreferences.isSimpleToken()) {
            this.simpleToken = simpleToken;
        } else {
            this.simpleToken = XMLConstants.NULL_NS_URI;
        }
        ...
        this.isAutoDateTimeEnabled = Boolean.valueOf(StartAppSDK.m3191e(context));
    ...
    private void setVideoRequestType(Context context) {
        ...
        } else if (com.startapp.android.publish.video.StartAppSDK.m3935a(context) == com.startapp.android.publish.video.StartAppSDK.StartAppSDK.ELIGIBLE) {
    ...
    private void fillLocationDetails(AdPreferences adPreferences, Context context) {
        ...
        if (adPreferences.getLatitude() == null || adPreferences.getLongitude() == null) {
            Location a = StartAppSDK.m3225a(context);
            if (a != null) {
                setLongitude(StartAppSDK.m3337c(String.valueOf(a.getLongitude())));
                setLatitude(StartAppSDK.m3337c(String.valueOf(a.getLatitude())));
                setLocationAccuracy(StartAppSDK.m3337c(String.valueOf(a.getAccuracy())));
                setLocationSource(StartAppSDK.m3337c(StartAppSDK.m3226a(a)));
            } else {
                z = false;
            }
        } else {
            setLongitude(StartAppSDK.m3337c(String.valueOf(adPreferences.getLongitude())));
            setLatitude(StartAppSDK.m3337c(String.valueOf(adPreferences.getLatitude())));
            setLocationSource(StartAppSDK.m3337c(MetaData.DEFAULT_LOCATION_SOURCE));
        }
        StartAppSDK.m3227a(context, z);
    }
    ...
    public List<NameValueObject> getNameValueMap() {
        ...
        StartAppSDK.m3317a(nameValueMap, "placement", this.placement.name(), true);
        StartAppSDK.m3317a(nameValueMap, "testMode", Boolean.toString(this.testMode), false);
        StartAppSDK.m3317a(nameValueMap, "longitude", this.longitude, false);
        StartAppSDK.m3317a(nameValueMap, "latitude", this.latitude, false);
        StartAppSDK.m3317a(nameValueMap, "locSrc", this.locSrc, false);
        StartAppSDK.m3317a(nameValueMap, "locAcc", this.locAcc, false);
        StartAppSDK.m3317a(nameValueMap, "locTs", this.locTs, false);
        StartAppSDK.m3317a(nameValueMap, "gender", this.gender, false);
        StartAppSDK.m3317a(nameValueMap, "age", this.age, false);
        StartAppSDK.m3317a(nameValueMap, "keywords", this.keywords, false);
        StartAppSDK.m3317a(nameValueMap, "template", this.template, false);
        StartAppSDK.m3317a(nameValueMap, "adsNumber", Integer.toString(this.adsNumber), false);
        StartAppSDK.m3319a(nameValueMap, "category", this.categories, false);
        StartAppSDK.m3319a(nameValueMap, "categoryExclude", this.categoriesExclude, false);
        StartAppSDK.m3319a(nameValueMap, "packageExclude", this.packageExclude, false);
        StartAppSDK.m3317a(nameValueMap, "offset", Integer.toString(this.offset), false);
        StartAppSDK.m3317a(nameValueMap, SchemaSymbols.ATTVAL_TOKEN, this.simpleToken, false);
        StartAppSDK.m3317a(nameValueMap, "engInclude", Boolean.toString(this.engInclude), false);
        if (!MetaData.getInstance().isDisableTwoClicks()) {
            StartAppSDK.m3317a(nameValueMap, "twoClicks", Boolean.toString(true), false);
        }
        StartAppSDK.m3317a(nameValueMap, "video", this.videoRequestType, false);
        if (getType() == AdType.INTERSTITIAL || getType() == AdType.RICH_TEXT) {
            StartAppSDK.m3317a(nameValueMap, "type", this.type, false);
        }
        StartAppSDK.m3317a(nameValueMap, "timeSinceSessionStart", Long.valueOf(this.timeSinceSessionStart), true);
        StartAppSDK.m3317a(nameValueMap, "adsDisplayed", Integer.valueOf(this.adsDisplayed), true);
        StartAppSDK.m3317a(nameValueMap, "profileId", this.profileId, false);
        StartAppSDK.m3317a(nameValueMap, "hardwareAccelerated", Boolean.valueOf(this.isHardwareAccelerated), false);
        StartAppSDK.m3317a(nameValueMap, "dts", this.isAutoDateTimeEnabled, false);
        StartAppSDK.m3317a(nameValueMap, "videoMode", this.videoRequestMode, false);
        StartAppSDK.m3317a(nameValueMap, "downloadingMode", (Object) "CACHE", false);
        Object a = StartAppSDK.m3192a();
        StartAppSDK.m3317a(nameValueMap, StartAppSDK.f3309b, a, true);
        StartAppSDK.m3318a(nameValueMap, StartAppSDK.f3311d, StartAppSDK.m3194b(getProductId() + this.placement.name() + getSessionId() + getSdkVersion() + a), true, false);
        if (getCountry() != null) {
            StartAppSDK.m3317a(nameValueMap, "country", getCountry(), false);
        }
        if (getAdvertiserId() != null) {
            StartAppSDK.m3317a(nameValueMap, "advertiserId", getAdvertiserId(), false);
        }
        if (getPackageInclude() != null) {
            StartAppSDK.m3319a(nameValueMap, "packageInclude", getPackageInclude(), false);
        }
        return nameValueMap;
    }
