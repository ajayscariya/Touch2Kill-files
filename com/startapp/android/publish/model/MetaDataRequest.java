...
public class MetaDataRequest extends BaseRequest {
    ...
    public MetaDataRequest(Context context, RequestReason reason) {
        this.totalSessions = StartAppSDK.m3209a(context, "totalSessions", Integer.valueOf(0)).intValue();
        this.daysSinceFirstSession = calcDaysSinceFirstSession(context);
        this.paidAmount = StartAppSDK.m3208a(context, "inAppPurchaseAmount", Float.valueOf(0.0f)).floatValue();
        this.payingUser = StartAppSDK.m3207a(context, "payingUser", Boolean.valueOf(false)).booleanValue();
        this.profileId = MetaData.getInstance().getProfileId();
        this.reason = reason;
    }

    private int calcDaysSinceFirstSession(Context context) {
        return millisToDays(System.currentTimeMillis() - StartAppSDK.m3210a(context, "firstSessionTime", Long.valueOf(System.currentTimeMillis())).longValue());
    }
    ...
    public List<NameValueObject> getNameValueMap() {
        ...
        StartAppSDK.m3317a(nameValueMap, "totalSessions", Integer.valueOf(this.totalSessions), true);
        StartAppSDK.m3317a(nameValueMap, "daysSinceFirstSession", Integer.valueOf(this.daysSinceFirstSession), true);
        StartAppSDK.m3317a(nameValueMap, "payingUser", Boolean.valueOf(this.payingUser), true);
        StartAppSDK.m3317a(nameValueMap, "profileId", this.profileId, false);
        StartAppSDK.m3317a(nameValueMap, "paidAmount", Float.valueOf(this.paidAmount), true);
        StartAppSDK.m3317a(nameValueMap, "reason", this.reason, true);
        return nameValueMap;
    }
}
