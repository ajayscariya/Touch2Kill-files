...
public class MetaData extends BaseResponse {
    ...
    private MetaData() {
        ...
        this.AdInformation = AdInformationConfig.m2821a();
        ...
        getAdInformationConfig().m2832f();
    }

    public static void init(Context context) {
        MetaData metaData = (MetaData) getGson().fromJson(context.getSharedPreferences("com.startapp.android.publish", DEFAULT_FULLSCREEN_OVERLAY_PROBABILITY).getString(KEY_METADATA, XMLConstants.NULL_NS_URI), MetaData.class);
        if (metaData != null) {
            instance = metaData;
        } else {
            instance = new MetaData();
        }
        getInstance().getAdInformationConfig().m2832f();
    ...
    public static void update(Context context, MetaData metaData) {
        synchronized (lock) {
            ...
            if (com.startapp.android.publish.StartAppSDK.m3036a().booleanValue()) {
                com.startapp.android.publish.p022h.StartAppSDK.m3230a(3, "MetaData received:");
                com.startapp.android.publish.p022h.StartAppSDK.m3230a(3, getGson().toJson((Object) metaData));
            }
            AdInformationConfig.m2822a(getInstance().AdInformation);
            ...
            edit.commit();
            com.startapp.android.publish.p022h.StartAppSDK.m3230a(3, "MetaData saved:");
            com.startapp.android.publish.p022h.StartAppSDK.m3230a(3, toJson);
            getInstance().applyAdPlatformProtocolToHosts();
            getInstance().getAdInformationConfig().m2832f();
            ...
            com.startapp.android.publish.p022h.StartAppSDK.m3214b(context, "totalSessions", Integer.valueOf(com.startapp.android.publish.p022h.StartAppSDK.m3209a(context, "totalSessions", Integer.valueOf(DEFAULT_FULLSCREEN_OVERLAY_PROBABILITY)).intValue() + 1));
            task = null;
        }
    }
