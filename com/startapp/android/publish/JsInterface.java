...
public class JsInterface {
    ...
    public void openApp(String clickUrl, String intentPackageName, String intentDetails) {
        if (!(clickUrl == null || TextUtils.isEmpty(clickUrl))) {
            StartAppSDK.m3333b(this.mContext, clickUrl, this.params);
        }
        ...
        try {
            ...
            com.startapp.android.publish.p010d.StartAppSDK.m3033a(this.mContext, com.startapp.android.publish.p010d.StartAppSDK.StartAppSDK.EXCEPTION, "JsInterface.openApp(): Couldn't start activity", e2.getMessage(), StartAppSDK.m3295a(clickUrl, null));
            StartAppSDK.m3230a(6, "Cannot find activity to handle url: [" + clickUrl + "]");
        }
