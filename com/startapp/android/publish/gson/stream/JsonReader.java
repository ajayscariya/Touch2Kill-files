        ...
        if (i == 1) {
            ...
            switch (nextNonWhitespace(true)) {
                case Tokens.EXPRTOKEN_AXISNAME_PRECEDING_SIBLING /*44*/:
                    break;
                case C0866R.styleable.Theme_toolbarNavigationButtonStyle /*59*/:
                    checkLenient();
                    break;
            ...
            switch (nextNonWhitespace(true)) {
                case C0866R.styleable.Theme_toolbarStyle /*58*/:
                    break;
                case C0866R.styleable.Theme_popupWindowStyle /*61*/:
                    checkLenient();
        ...
        while (true) {
            ...
            switch (c) {
                ...
                case Tokens.EXPRTOKEN_LITERAL /*46*/:
                    ...
                    obj2 = obj;
                    continue;
                case C0866R.styleable.Theme_listPreferredItemHeight /*69*/:
