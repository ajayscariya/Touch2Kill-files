...
public class Banner extends FrameLayout implements BannerInterface {
    ...
    class StartAppSDK implements OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            com.startapp.android.publish.p022h.StartAppSDK.m3173a(Banner.this.getViewTreeObserver(), (OnGlobalLayoutListener) this);
    ...
    private void initBanner() {
        if (!this.initBannerCalled) {
            ...
            com.startapp.android.publish.p022h.StartAppSDK.m3300a(getContext(), adPreferences);
    ...
    private void init_step2() {
        ...
        if (this.bFirstTime) {
            int j = this.options.m2941j();
            int nextInt = new Random().nextInt(100);
            this.type = BType.REGULAR;
            if (nextInt < j) {
                this.type = BType.THREED;
            }
            com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "BannerProbability [" + nextInt + "\\" + j + "]");
        }
        switch (StartAppSDK.$SwitchMap$com$startapp$android$publish$banner$Banner$BType[this.type.ordinal()]) {
            case MainNavigationActivity.REQUEST_CODE /*1*/:
                com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "BannerDisplaying REGULAR");
                this.banner3D.hideBanner();
                this.bannerHtml.loadBanner();
                break;
            case DurationDV.DAYTIMEDURATION_TYPE /*2*/:
                com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "BannerDisplaying 3D");
