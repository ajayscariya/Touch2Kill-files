...
public class Banner3D extends com.startapp.android.publish.banner.StartAppSDK implements AdEventListener, BannerInterface {
    ...
    private com.startapp.android.publish.p027a.StartAppSDK ads;
        ...
        public void run() {
            if (Banner3D.this.loaded && Banner3D.this.faces.size() != 0) {
                if (Banner3D.this.visible && Banner3D.this.isShown() && Banner3D.this.drawn) {
                    ((Banner3DFace) Banner3D.this.faces.get(Banner3D.this.getCurrentBannerIndex())).m5382a(Banner3D.this.getContext());
                ...
                if (Banner3D.this.rotationEnabled) {
                    Banner3D.this.rotate((float) ((!Banner3D.this.firstRotationFinished ? Banner3D.this.options.m2948q() : 1) * Banner3D.this.getBannerOptions().m2933b()));
                }
                if (Banner3D.this.rotation <= ((float) (90 - Banner3D.this.getBannerOptions().m2933b())) || Banner3D.this.rotation >= ((float) (Banner3D.this.getBannerOptions().m2933b() + 90)) || Banner3D.this.firstRotation) {
                    Banner3D.this.postDelayed(this, (long) Banner3D.this.getBannerOptions().m2931a());
                    Banner3D.this.rotating = true;
                } else {
                    if (Banner3D.this.attachedToWindow) {
                        Banner3D.this.postDelayed(this, (long) Banner3D.this.getBannerOptions().m2934c());
                    }
    ...
    private void addAdInformationLayout() {
        ...
        new com.startapp.android.publish.adinformation.StartAppSDK(getContext(), com.startapp.android.publish.adinformation.StartAppSDK.StartAppSDK.SMALL, Placement.INAPP_BANNER, this.overrides).m2852a(relativeLayout);
    }
    ...
    private void initRuntime() {
        if (!this.loading) {
            ...
            this.overrides = com.startapp.android.publish.adinformation.StartAppSDK.m2855a();
            this.faces = new ArrayList();
            this.loading = true;
    ...
    protected void reload() {
        ...
        this.faces = new ArrayList();
        this.ads = new com.startapp.android.publish.p027a.StartAppSDK(getContext(), getOffset());
        if (this.adPreferences == null) {
            this.adPreferences = new AdPreferences();
        }
    ...
    private void loadBanners(List<AdDetails> adsItems, boolean sendCallback) {
        ...
        if (adsItems != null) {
            ...
            if (setBannerSize(startAppSDK)) {
                setMinimumWidth(com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), this.options.m2935d()));
                setMinimumHeight(com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), this.options.m2936e()));
                if (getLayoutParams() != null && getLayoutParams().width == -1) {
                    setMinimumWidth(com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), startAppSDK.m2949a()));
                }
                if (getLayoutParams() != null && getLayoutParams().height == -1) {
                    setMinimumHeight(com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), startAppSDK.m2952b()));
                }
            ...
            com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 6, "Banner3DError in banner screen size");
            setVisibility(8);
            if (this.listener != null && sendCallback) {
    ...
    private void initFacesViews() {
        for (Banner3DFace a : this.faces) {
            a.m5383a(getContext(), getBannerOptions(), this);
        }
    }
    ...
    private boolean setBannerSize(com.startapp.android.publish.banner.StartAppSDK bannerSize) {
        return Banner3DSize.m2958a(getContext(), getParent(), getBannerOptions(), this, bannerSize);
    }

    private Bitmap getCurrentBitmap() {
        return ((Banner3DFace) this.faces.get(getCurrentBannerIndex())).m5385b();
    }

    private Bitmap getPreviousBitmap() {
        return ((Banner3DFace) this.faces.get(((getCurrentBannerIndex() - 1) + this.faces.size()) % this.faces.size())).m5385b();
    }
    ...
    private void drawFrame(Canvas canvas) {
        try {
            ...
            float m = this.options.m2944m() + (((float) Math.pow((double) (Math.abs(this.rotation - 45.0f) / 45.0f), (double) this.options.m2945n())) * (DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.options.m2944m()));
            if (!this.firstRotationFinished) {
                m = this.options.m2944m();
            }
            ...
            if (currentBitmap != null && previousBitmap != null) {
                if (this.rotation < 45.0f) {
                    if (this.rotation > 3.0f) {
                        drawFace(canvas, currentBitmap, faceStartTop, faceStartLeft, faceWidth / 2, faceHeight / 2, m, (this.rotation - 90.0f) * ((float) this.options.m2946o().getRotationMultiplier()));
                    }
                    drawFace(canvas, previousBitmap, faceStartTop, faceStartLeft, faceWidth / 2, faceHeight / 2, m, this.rotation * ((float) this.options.m2946o().getRotationMultiplier()));
                    return;
                }
            ...
            com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 6, "Exception onDraw Banner3D");
        }
    }
    ...
    private int getFaceHeight() {
        return (int) (((float) com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), this.options.m2936e())) * this.options.m2943l());
    }

    private int getFaceWidth() {
        return (int) (((float) com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), this.options.m2935d())) * this.options.m2942k());
    }
        ...
        switch (event.getAction()) {
            ...
            case MainNavigationActivity.REQUEST_CODE /*1*/:
                if (this.touchDown) {
                    ...
                    ((Banner3DFace) this.faces.get(getCurrentBannerIndex())).m5386b(getContext());
    ...
    public void onReceiveAd(Ad ad) {
        ...
        loadBanners(((com.startapp.android.publish.p027a.StartAppSDK) ad).m5373b(), true);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.options == null || !this.options.m2947p()) {
    ...
    protected int getRefreshRate() {
        return MetaData.getInstance().getBannerOptions().m2939h();
    }
