...
public class BannerStandard extends com.startapp.android.publish.banner.StartAppSDK implements AdEventListener, BannerInterface {
    ...
    private com.startapp.android.publish.p027a.StartAppSDK adHtml;
    ...
    class StartAppSDK implements OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            com.startapp.android.publish.p022h.StartAppSDK.m3173a(BannerStandard.this.getViewTreeObserver(), (OnGlobalLayoutListener) this);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.contains("index=")) {
                try {
                    int a = com.startapp.android.publish.p022h.StartAppSDK.m3290a(url);
                    if (BannerStandard.this.adHtml.getSmartRedirect(a)) {
                        ...
                        com.startapp.android.publish.p022h.StartAppSDK.m3305a(context, url, str, str2, new com.startapp.android.publish.p022h.StartAppSDK(BannerStandard.this.getAdTag()), 5000, BannerStandard.this.adHtml.isInAppBrowserEnabled());
                    } else {
                        String str3;
                        ...
                        com.startapp.android.publish.p022h.StartAppSDK.m3303a(context2, url, str3, new com.startapp.android.publish.p022h.StartAppSDK(BannerStandard.this.getAdTag()), BannerStandard.this.adHtml.isInAppBrowserEnabled());
                    }
                } catch (Exception e) {
                    com.startapp.android.publish.p022h.StartAppSDK.m3232a(BannerStandard.TAG, 6, "Error while trying parsing index from url");
                    return false;
                }
            } else if (BannerStandard.this.adHtml.getSmartRedirect(0)) {
                com.startapp.android.publish.p022h.StartAppSDK.m3305a(BannerStandard.this.getContext(), url, BannerStandard.this.adHtml.getTrackingClickUrls()[0], BannerStandard.this.adHtml.getPackageNames()[0], new com.startapp.android.publish.p022h.StartAppSDK(BannerStandard.this.getAdTag()), 5000, BannerStandard.this.adHtml.isInAppBrowserEnabled());
            } else {
                com.startapp.android.publish.p022h.StartAppSDK.m3303a(BannerStandard.this.getContext(), url, BannerStandard.this.adHtml.getTrackingClickUrls()[0], new com.startapp.android.publish.p022h.StartAppSDK(BannerStandard.this.getAdTag()), BannerStandard.this.adHtml.isInAppBrowserEnabled());
            }
    ...
    public BannerStandard(Context context, boolean defaultLoad, AdPreferences adPreferences) {
        super(context);
        this.prevAdId = XMLConstants.NULL_NS_URI;
        this.loaded = false;
    ...
    private void addAdInformationLayout() {
        ...
        if (this.adInformationLayout == null && this.adInformationContatiner == null) {
            ...
            this.adInformationLayout.m2852a(this.adInformationContatiner);
        }
        try {
    ...
    private void init() {
        if (isInEditMode()) {
            setMinimumWidth(com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), 300));
            setMinimumHeight(com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), 50));
        ...
        this.size = new com.startapp.android.publish.banner.StartAppSDK(300, 50);
        this.adHtml = new com.startapp.android.publish.p027a.StartAppSDK(getContext(), getOffset());
    ...
    private void initBanner() {
        if (!this.initBannerCalled) {
            com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "Initializing BannerHtml");
            this.initBannerCalled = true;
            int a = com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), this.size.m2949a());
            int a2 = com.startapp.android.publish.p022h.StartAppSDK.m3270a(getContext(), this.size.m2952b());
            setMinimumWidth(a);
            setMinimumHeight(a2);
            ...
            if (this.loaded) {
                com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "BannerHTML already Loaded");
    ...
    protected void reload() {
        com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "Loading from network");
        if (this.adPreferences == null) {
            this.adPreferences = new AdPreferences();
        }
    ...
    private Point getAvailableSize() {
        ...
        if (getLayoutParams() != null && getLayoutParams().width > 0) {
            point.x = com.startapp.android.publish.p022h.StartAppSDK.m3277b(getContext(), getLayoutParams().width + 1);
        }
        if (getLayoutParams() != null && getLayoutParams().height > 0) {
            point.y = com.startapp.android.publish.p022h.StartAppSDK.m3277b(getContext(), getLayoutParams().height + 1);
        }
                ...
                try {
                    ...
                    while (view != null && (view.getMeasuredWidth() <= 0 || view.getMeasuredHeight() <= 0)) {
                        if (view.getMeasuredWidth() > 0) {
                            setPointWidthIfNotSet(point, com.startapp.android.publish.p022h.StartAppSDK.m3277b(getContext(), (view.getMeasuredWidth() - view.getPaddingLeft()) - view.getPaddingRight()));
                        }
                        if (view.getMeasuredHeight() > 0) {
                            setPointHeightIfNotSet(point, com.startapp.android.publish.p022h.StartAppSDK.m3277b(getContext(), (view.getMeasuredHeight() - view.getPaddingBottom()) - view.getPaddingTop()));
                        }
                        view = (View) view.getParent();
                    }
                    if (view == null) {
        ...
        com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "============ exit Application Size [" + point.x + "," + point.y + "] =========");
        return point;
    }

    private void determineSizeByScreen(Point result, View window) {
        setPointWidthIfNotSet(result, com.startapp.android.publish.p022h.StartAppSDK.m3277b(getContext(), window.getMeasuredWidth()));
        setPointHeightIfNotSet(result, com.startapp.android.publish.p022h.StartAppSDK.m3277b(getContext(), window.getMeasuredHeight()));
    }
    ...
    public void onReceiveAd(Ad ad) {
        com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, " Html Ad Recievied OK");
        this.sentImpression = false;
        removeView(this.adInformationContatiner);
        if (this.adHtml == null || this.adHtml.getHtml() == null || this.adHtml.getHtml().compareTo(XMLConstants.NULL_NS_URI) == 0) {
            com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 6, "No Banner recieved");
            onFailedToReceiveBanner();
        } else {
            String a = com.startapp.android.publish.p022h.StartAppSDK.m3296a(this.adHtml.getHtml(), "@adId@", "@adId@");
            if (a == null || this.prevAdId == null || this.prevAdId.compareTo(a) != 0) {
                this.prevAdId = a;
                loadHtml();
                try {
                    if (setSize(Integer.parseInt(com.startapp.android.publish.p022h.StartAppSDK.m3296a(this.adHtml.getHtml(), "@width@", "@width@")), Integer.parseInt(com.startapp.android.publish.p022h.StartAppSDK.m3296a(this.adHtml.getHtml(), "@height@", "@height@")))) {
                        this.loaded = true;
                    ...
                    com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 6, "Error Casting width & height from HTML");
                    onFailedToReceiveBanner();
                }
            } else {
                addAdInformationLayout();
        ...
        if (this.loaded) {
            ...
            com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "Done Loading HTML Banner");
        }
    }
    ...
    private void loadHtml() {
        com.startapp.android.publish.p022h.StartAppSDK.m3311a(this.webView, this.adHtml.getHtml());
    }

    private void makeImpression() {
        if (!this.sentImpression && this.visible && isShown()) {
            com.startapp.android.publish.p022h.StartAppSDK.m3307a(getContext(), this.adHtml.getTrackingUrls(), new com.startapp.android.publish.p022h.StartAppSDK(getAdTag()));
    ...
    private void onResume() {
        if (this.webView != null) {
            com.startapp.android.publish.p022h.StartAppSDK.m3189c(this.webView);
        }
    }

    private void onPause() {
        if (this.webView != null) {
            com.startapp.android.publish.p022h.StartAppSDK.m3185b(this.webView);
        }
    }
