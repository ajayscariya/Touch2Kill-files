...
public abstract class StartAppSDK extends RelativeLayout {
    ...
    private class StartAppSDK extends TimerTask {
        final /* synthetic */ StartAppSDK f3092a;

        /* renamed from: com.startapp.android.publish.banner.a.a.1 */
        class StartAppSDK implements Runnable {
            final /* synthetic */ StartAppSDK f3091a;

            StartAppSDK(StartAppSDK startAppSDK) {
                this.f3091a = startAppSDK;
            }

            public void run() {
                if (this.f3091a.f3092a.isShown() || !(this.f3091a.f3092a.adRulesResult == null || this.f3091a.f3092a.adRulesResult.shouldDisplayAd())) {
                    com.startapp.android.publish.p022h.StartAppSDK.m3232a(StartAppSDK.TAG, 3, "REFRESH");
                    this.f3091a.f3092a.load();
                }
            }
        }

        private StartAppSDK(StartAppSDK startAppSDK) {
            this.f3092a = startAppSDK;
        }

        public void run() {
            this.f3092a.post(new StartAppSDK(this));
        }
    }
    ...
    protected void load() {
        if (this.adRulesResult == null || MetaData.getInstance().getAdRules().isApplyOnBannerRefresh()) {
            ...
            if (com.startapp.android.publish.StartAppSDK.m3036a().booleanValue()) {
                com.startapp.android.publish.p022h.StartAppSDK.m3258a().m3259a(getContext(), this.adRulesResult.getReason());
            }
    ...
    protected void onAttachedToWindow() {
        ...
        com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "onAttachedToWindow");
    ...
    protected void onDetachedFromWindow() {
        ...
        com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "onDetachedFromWindow");
        this.attachedToWindow = false;
        cancelReloadTask();
    }
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        com.startapp.android.publish.p022h.StartAppSDK.m3232a(TAG, 3, "onWindowFocusChanged");
        if (hasWindowFocus) {
    ...
    protected void setHardwareAcceleration(AdPreferences adPreferences) {
        com.startapp.android.publish.p022h.StartAppSDK.m3314a(adPreferences, "hardwareAccelerated", com.startapp.android.publish.p022h.StartAppSDK.m3182a((View) this, this.attachedToWindow));
    }
