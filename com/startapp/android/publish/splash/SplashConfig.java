...
public class SplashConfig implements Serializable {
    ...
    static /* synthetic */ class StartAppSDK {
        static final /* synthetic */ int[] f3589x67b27dff;

        static {
            f3589x67b27dff = new int[Theme.values().length];
            try {
                f3589x67b27dff[Theme.USER_DEFINED.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f3589x67b27dff[Theme.DEEP_BLUE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f3589x67b27dff[Theme.SKY.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f3589x67b27dff[Theme.ASHEN_SKY.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f3589x67b27dff[Theme.BLAZE.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f3589x67b27dff[Theme.GLOOMY.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f3589x67b27dff[Theme.OCEAN.ordinal()] = 7;
    ...
    protected boolean validate(Context context) {
        switch (StartAppSDK.f3589x67b27dff[getTheme().ordinal()]) {
            ...
            default:
                if (getAppName().compareTo(STRING_EMPTY_VALUE) == 0) {
                    setAppName(com.startapp.android.publish.p022h.StartAppSDK.m3294a(context, "Welcome!"));
                }
    ...
    protected View getLayout(Context context) {
        switch (StartAppSDK.f3589x67b27dff[getTheme().ordinal()]) {
            ...
            default:
                return StartAppSDK.m3887a(context, this);
        }
    }
