...
public class FileManager {
    ...
    public static int f1385b04270427042704270427 = 75;
    public static int f1386b0427042704270427 = 1;
    public static int f1387b0427042704270427 = 2;
    public static int f1388b04270427;
    Context f1389a;
    private int f1390b;
    ...
    public static int m1411b042704270427() {
        return 0;
    }

    public static int m1412b042704270427() {
        return 2;
    }

    public static int m1413b042704270427() {
        return 28;
    }

    public void closeCloseable(Closeable closeable) {
        if (((m1413b042704270427() + f1386b0427042704270427) * m1413b042704270427()) % m1412b042704270427() != f1388b04270427) {
            f1385b04270427042704270427 = m1413b042704270427();
            f1388b04270427 = m1413b042704270427();
        }
        if (closeable != null) {
            try {
                closeable.close();
    ...
    public void deleteHapticStorage() {
        try {
            ...
            if (listFiles != null) {
                int bЧЧ04270427Ч0427 = m1413b042704270427();
                switch ((bЧЧ04270427Ч0427 * (f1386b0427042704270427 + bЧЧ04270427Ч0427)) % f1387b0427042704270427) {
                    case DurationDV.DURATION_TYPE /*0*/:
                        break;
                    default:
                        f1386b0427042704270427 = 63;
                        break;
                }
                for (File file : listFiles) {
                    if (file.getName().endsWith(this.f1390b + HAPTIC_STORAGE_FILENAME)) {
                        try {
                            file.delete();
                        } catch (Exception e) {
                            throw e;
    ...
    public File getHapticStorageFile(String str) {
        try {
            try {
                String path = this.f1389a.getFilesDir().getPath();
                StringBuilder append = new StringBuilder().append(getUniqueFileName(str));
                String str2 = HAPTIC_STORAGE_FILENAME;
                if (((f1385b04270427042704270427 + f1386b0427042704270427) * f1385b04270427042704270427) % f1387b0427042704270427 != m1411b042704270427()) {
                    f1385b04270427042704270427 = m1413b042704270427();
                    f1388b04270427 = m1413b042704270427();
                }
    ...
    public String getInternalHapticPath() {
        File filesDir = this.f1389a.getFilesDir();
        int bЧЧ04270427Ч0427 = m1413b042704270427();
        switch ((bЧЧ04270427Ч0427 * (f1386b0427042704270427 + bЧЧ04270427Ч0427)) % f1387b0427042704270427) {
            case DurationDV.DURATION_TYPE /*0*/:
                break;
            default:
                f1386b0427042704270427 = 65;
                break;
        }
    ...
    public String getUniqueFileName(String str) {
        try {
            ...
            if (((f1385b04270427042704270427 + f1386b0427042704270427) * f1385b04270427042704270427) % f1387b0427042704270427 != f1388b04270427) {
                f1385b04270427042704270427 = m1413b042704270427();
                f1388b04270427 = 59;
            }
            objArr[1] = Integer.valueOf(this.f1390b);
    ...
    public java.io.BufferedOutputStream makeOutputStream(java.lang.String r9) {
        ...
        r5 = f1385b04270427042704270427;
        r6 = f1386b0427042704270427;
        r6 = r6 + r5;
        r5 = r5 * r6;
        r6 = f1387b0427042704270427;
        r5 = r5 % r6;
        switch(r5) {
    ...
    L_0x001e:
        r5 = 73;
        f1385b04270427042704270427 = r5;
        r5 = m1413b042704270427();
        f1388b04270427 = r5;
    L_0x0028:
        ...
        r2 = r8.f1389a;	 Catch:{ Exception -> 0x006a }
        r5 = 0;
    ...
    public BufferedOutputStream makeOutputStreamForStreaming(String str) {
        try {
            try {
                OutputStream openFileOutput = this.f1389a.openFileOutput(getUniqueFileName(str) + HAPTIC_STORAGE_FILENAME, 0);
                if (((f1385b04270427042704270427 + f1386b0427042704270427) * f1385b04270427042704270427) % f1387b0427042704270427 != f1388b04270427) {
                    f1385b04270427042704270427 = 23;
                    f1388b04270427 = m1413b042704270427();
                }
