...
import com.astuetz.pagerslidingtabstrip.C0250R;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    class C02482 implements OnGlobalLayoutListener {
        C02482() {
        }
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mLastScrollX = 0;
        this.mTabBackgroundResId = C0250R.drawable.psts_background_tab;
        this.firstTabGlobalLayoutListener = new C02482();
        ...
        a = context.obtainStyledAttributes(attrs, C0250R.styleable.PagerSlidingTabStrip);
        this.mIndicatorColor = a.getColor(C0250R.styleable.PagerSlidingTabStrip_pstsIndicatorColor, this.mIndicatorColor);
        this.mIndicatorHeight = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight, this.mIndicatorHeight);
        this.mUnderlineColor = a.getColor(C0250R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, this.mUnderlineColor);
        this.mUnderlineHeight = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight, this.mUnderlineHeight);
        this.mDividerColor = a.getColor(C0250R.styleable.PagerSlidingTabStrip_pstsDividerColor, this.mDividerColor);
        this.mDividerWidth = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsDividerWidth, this.mDividerWidth);
        this.mDividerPadding = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsDividerPadding, this.mDividerPadding);
        this.isExpandTabs = a.getBoolean(C0250R.styleable.PagerSlidingTabStrip_pstsShouldExpand, this.isExpandTabs);
        this.mScrollOffset = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsScrollOffset, this.mScrollOffset);
        this.isPaddingMiddle = a.getBoolean(C0250R.styleable.PagerSlidingTabStrip_pstsPaddingMiddle, this.isPaddingMiddle);
        this.mTabPadding = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, this.mTabPadding);
        this.mTabBackgroundResId = a.getResourceId(C0250R.styleable.PagerSlidingTabStrip_pstsTabBackground, this.mTabBackgroundResId);
        this.mTabTextSize = a.getDimensionPixelSize(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextSize, this.mTabTextSize);
        this.mTabTextColor = a.hasValue(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextColor) ? a.getColorStateList(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextColor) : null;
        this.mTabTextTypefaceStyle = a.getInt(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextStyle, this.mTabTextTypefaceStyle);
        this.isTabTextAllCaps = a.getBoolean(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextAllCaps, this.isTabTextAllCaps);
        int tabTextAlpha = a.getInt(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextAlpha, DEF_VALUE_TAB_TEXT_ALPHA);
        String fontFamily = a.getString(C0250R.styleable.PagerSlidingTabStrip_pstsTabTextFontFamily);
        a.recycle();
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.mTabCount; i += PADDING_INDEX) {
            ...
            if (this.isCustomTabs) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(C0250R.layout.psts_tab, this, false);
            }
    ...
    private void addTab(int position, CharSequence title, View tabView) {
        TextView textView = (TextView) tabView.findViewById(C0250R.id.psts_tab_title);
        if (!(textView == null || title == null)) {
            textView.setText(title);
        }
        tabView.setFocusable(true);
        tabView.setOnClickListener(new C02471(position));
    ...
    private void updateTabStyles() {
        for (int i = 0; i < this.mTabCount; i += PADDING_INDEX) {
            ...
            TextView tab_title = (TextView) v.findViewById(C0250R.id.psts_tab_title);
            if (tab_title != null) {
    ...
    private void unSelect(View tab) {
        if (tab != null) {
            TextView tab_title = (TextView) tab.findViewById(C0250R.id.psts_tab_title);
            if (tab_title != null) {
